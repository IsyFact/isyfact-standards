...
public class XmlAccessTest {
    ...
    public void testRechtMitProperties() {
        RollenRechteMapping mapping =
            xmlAccess.parseRollenRechteFile(ROLLEN_RECHTE_XML_PATH + "rollenrechte_property.xml");
    ...
    public void testUnbekannteRechteIdInRolle() {
        xmlAccess
            .parseRollenRechteFile(ROLLEN_RECHTE_XML_PATH + "rollenrechte_UnbekannteRechteIdInRolle.xml");
    }
    ...
    public void testRechtOhneIdElementInRolle() {
        xmlAccess
            .parseRollenRechteFile(ROLLEN_RECHTE_XML_PATH + "rollenrechte_RechteOhneIdElementInRolle.xml");
    }
}
