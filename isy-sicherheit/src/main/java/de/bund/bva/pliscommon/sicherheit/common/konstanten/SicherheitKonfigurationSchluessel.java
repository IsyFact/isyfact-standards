...
/**
 * Diese Klasse enthaelt alle Schluessel, welche zum Auslesen von Konfigurationen verwendet werden.
 * 
 * 
 */
public abstract class SicherheitKonfigurationSchluessel {
    
    /** Maximale Lebenszeit eines gecachten Eintrags.**/
    public static final String CONF_CACHE_TTL = "sic.caching.ttl";
    
    /** Maximale Anzahl an Elementen im Cache. **/
