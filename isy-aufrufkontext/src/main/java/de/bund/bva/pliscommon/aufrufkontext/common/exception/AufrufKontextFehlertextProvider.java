 ...
 * 
 */
public class AufrufKontextFehlertextProvider implements de.bund.bva.pliscommon.exception.FehlertextProvider {
    /**
     * Das ResourceBoundle mit den Fehlertexten der AufrufkontextAPI.
     */
    public static final ResourceBundle FEHLERTEXT_BUNDLE =
        ResourceBundle.getBundle("resources/plis-aufrufkontext/nachrichten/aufrufkontextfehler", Locale.GERMANY);
