...
import de.bund.bva.pliscommon.exception.util.TestExceptionFactory.MyPlisBusinessException;
...
public class TestPlisBusinessException {
	...
	public void testPlisBusinessException(){		
		MyPlisBusinessException pbe = TestExceptionFactory.getPlisBusinessException();
	...
	public void testPlisBusinessException2(){
		MyPlisBusinessException pbe = TestExceptionFactory.getPlisBusinessException(pE);
		assertEquals(TestExceptionFactory.ausnahmeId, pbe.getAusnahmeId());
	...
	public void testPlisBusinessException3(){
		...
		MyPlisBusinessException pbe = TestExceptionFactory.getPlisBusinessException(e);
		assertEquals(TestExceptionFactory.ausnahmeId, pbe.getAusnahmeId());
	...
	public void testPlisBusinessException4(){
		MyPlisBusinessException pbe = TestExceptionFactory.getPlisBusinessException(ptE);
		assertEquals(TestExceptionFactory.ausnahmeId, pbe.getAusnahmeId());
