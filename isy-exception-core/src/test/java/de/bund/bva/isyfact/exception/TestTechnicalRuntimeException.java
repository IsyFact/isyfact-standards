...
public class TestTechnicalRuntimeException {
    ...
    @Before
    public void setUp() {
        pE = new BaseException(TestExceptionFactory.ausnahmeId, TestExceptionFactory.provider,
            TestExceptionFactory.parameter) {
        };
        ptE = new TechnicalRuntimeException(TestExceptionFactory.ausnahmeId, TestExceptionFactory.provider,
            TestExceptionFactory.parameter) {
        };
    }
    ...
    public void testGetterRuntimeException() {
        TestExceptionFactory.MyTechnicalRuntimeException pte =
            TestExceptionFactory.getTechnicalRuntimeException();
    ...
    public void testGetterRuntimeException2() {
        ...
        assertEquals(TestExceptionFactory.ausnahmeId, pte.getAusnahmeId());
        assertEquals(
            TestExceptionFactory.provider.getMessage(TestExceptionFactory.ausnahmeId,
                TestExceptionFactory.parameter),
            pte.getFehlertext());
    }
    ...
    public void testBusinessException2() {
        TestExceptionFactory.MyTechnicalRuntimeException pte =
            TestExceptionFactory.getTechnicalRuntimeException(pE);
        assertEquals(TestExceptionFactory.ausnahmeId, pte.getAusnahmeId());
    ...
    public void testBusinessException4() {
        TestExceptionFactory.MyTechnicalRuntimeException pte =
            TestExceptionFactory.getTechnicalRuntimeException(ptE);
        assertEquals(TestExceptionFactory.ausnahmeId, pte.getAusnahmeId());
    ...
    public void testBusinessException5() {
        ...
        TestExceptionFactory.MyTechnicalRuntimeException pte =
            TestExceptionFactory.getTechnicalRuntimeException(e);
        assertEquals(TestExceptionFactory.ausnahmeId, pte.getAusnahmeId());
