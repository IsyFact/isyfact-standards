 ...
 */
package de.bund.bva.pliscommon.exception.service.bridge.util;
...
/**
 * Diese Klasse bietet Methoden zur Uebernahme von Inhalten von Anwendungsexceptions aus dem 1.8 Namespace in
 * Schnittstellen bzw. Transportexceptions des 2.1 Namespaces.
 * <p>
...
public class BridgeExceptionMapper {
     ...
     *             übergeben wurde.
     */
    public static <T extends ToException> T mapException(PlisException plisException,
        ...
        try {
            ...
            LOG.error(EreignisSchluessel.KONSTRUKTOR_NICHT_IMPLEMENTIERT,
                    ...
                    t, transportExceptionClass, plisException.getClass(),
    ...
    public static <T extends ToException> T mapException(
        ...
        try {
            ...
            LOG.error(EreignisSchluessel.KONSTRUKTOR_NICHT_IMPLEMENTIERT,
                    ...
                    t, transportExceptionClass, plisTechnicalRuntimeException.getClass(),
