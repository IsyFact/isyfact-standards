...
Das Beispiel in <<image-007>> zeigt eine fachliche Exception einer unbestimmten Anwendung.
...
Die <<image-008>> zeigt die technische Runtime-Exception `MeineKonfigurationException`.
...
[source,properties]
----
MNMDL90001 = Es ist ein allgemeiner Fehler im Modul Generisches Modul aufgetreten.
----
...
[source,java]
----
new MeineKonfigurationException(
...
[source,java]
----
new MeineKonfigurationException(FehlerSchluessel.MSG_UNGUELTIGER_PARAMETER, parameter, wert);
----
