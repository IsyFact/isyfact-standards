...
Die Ablage der Fehlertexte wird durch das xref:ueberwachung::konzept.adoc[Konzept Überwachung] vorgegeben, das Laden der Dateien wird in Spring durch Holder-Klassen realisiert.
