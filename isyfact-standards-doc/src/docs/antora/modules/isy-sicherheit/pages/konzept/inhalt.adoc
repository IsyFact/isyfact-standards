...
entweder in der Querschnittsanwendung Benutzerverzeichnis oder in der xref:glossary:glossary:master.adoc#glossar-Querschnittskomponente[Querschnittsanwendung] Benutzerverwaltung.
