...
entweder in der Querschnittsanwendung Benutzerverzeichnis oder in der xref:glossary:glossary:master.adoc#glossar-Querschnittskomponente[Querschnittskomponente] Benutzerverwaltung.
...
Für xref:glossary:glossary:master.adoc#glossar-Service[Services] des Querschnitts, die nahezu alle Aufrufe benötigen und die keine sicherheitskritischen Operationen anbieten, kann eine zentrale Rolle (z.B. `Querschnitt_Nutzer`) angelegt werden.
