...
Die Abbildung xref:konzept/master.adoc#image-rollen-beziehungen[Beziehungen zwischen fachlichen und technischen Rollen] verdeutlicht den Inhalt der folgenden Abschnitte grafisch.
