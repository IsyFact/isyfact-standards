...
In der xref:blaupausen:referenzarchitektur-it-system/master.adoc[] werden drei Möglichkeiten des Zugriffs auf ein IT-System: Grafische Oberflächen (GUIs), Services und Batches beschrieben.
