...
NOTE: Details hierzu können in der xref:literaturextern:inhalt.adoc#litextern-spring-boot-properties-conversion[Spring Boot Dokumentation zu "Properties Conversion"] nachgelesen werden.
