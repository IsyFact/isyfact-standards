...
* Alle Anwendungen und Batches, die schreibend auf eine andere Geschäftsanwendung zugreifen, müssen auf die Nichtverfügbarkeit dieser Komponente vorbereitet sein.
