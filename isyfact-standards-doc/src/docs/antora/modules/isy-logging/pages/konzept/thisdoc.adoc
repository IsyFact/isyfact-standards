...
+
Das Monitoring zur betrieblichen Überwachung der Anwendungslandschaft und frühzeitigen Eskalation von Problemen ist im  xref:ueberwachung::konzept.adoc#einleitung[Konzept Überwachung] beschrieben.
+
