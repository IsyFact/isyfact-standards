...
****
Beim Loggen der Nachrichten sind grundsätzlich die Vorgaben der Datenschutzgrundverordnung (xref:literaturextern:inhalt.adoc#litextern-dsgvo[DSGVO]) einzuhalten.
