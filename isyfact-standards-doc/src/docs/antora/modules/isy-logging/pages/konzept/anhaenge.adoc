...
Eine detaillierte Abgrenzung zum Logging befindet sich in der xref:konzept/thisdoc.adoc[Einleitung]. |
|Monitoring |Betriebliche Überwachung der Anwendungslandschaft zur frühzeitigen Eskalation von Problemen. +
Eine detaillierte Abgrenzung zum Logging befindet sich in der xref:konzept/thisdoc.adoc[Einleitung]. |Überwachung
|====
