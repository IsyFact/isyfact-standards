...
NOTE: Siehe auch bei xref:literaturextern:inhalt.adoc#litextern-slf4j-fatal[SLF4J FATAL]
...
NOTE: Weitere Informationen über SLF4J unter xref:literaturextern:inhalt.adoc#litextern-slf4j-bridge-handler[SLF4JBridgeHandler]
