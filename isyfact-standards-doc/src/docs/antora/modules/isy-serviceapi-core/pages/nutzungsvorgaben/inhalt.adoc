...
Wird bei der Deserialisierung die Integrität der Daten nicht sichergestellt, können Angreifer schadhaften Code über eine HTTP-Invoker-Schnittstelle einschleusen (siehe xref:literaturextern:inhalt.adoc#litextern-cwe-502[CWE-502]).
