...
Siehe Kapitel xref:methodik:namenskonventionen/inhalt.adoc#namen-von-anwendungssystemen[Namen von Anwendungssystemen]. Wenn es sich um eine Querschnittsanwendung handelt, muss dieser mit dem Präfix „isy-“ beginnen.
