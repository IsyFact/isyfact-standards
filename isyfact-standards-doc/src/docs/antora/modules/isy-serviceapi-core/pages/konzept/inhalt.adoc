...
Siehe Kapitel xref:methodik:namenskonventionen/master.adoc#namen-von-anwendungssystemen[Namen von Anwendungssystemen]. Wenn es sich um eine Querschnittsanwendung handelt, muss dieser mit dem Präfix „isy-“ beginnen.
