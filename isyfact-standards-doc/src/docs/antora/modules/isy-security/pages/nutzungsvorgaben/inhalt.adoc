...
`void authentifiziereSystem(String registrationId, String username, String password, @Nullable String bhknz)`:: Authentifiziert einen Client anhand `registrationId`, `username`, `password`  und (optional) `bhknz`. Der Parameter `registrationId` verweist auf eine
