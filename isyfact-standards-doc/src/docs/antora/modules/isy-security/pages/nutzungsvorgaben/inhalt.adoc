...
Für detaillierte Informationen und Anleitung zur Absicherung von Batches wird auf die Dokumentation unter xref:blaupausen:detailkonzept-komponente-batch/inhalt.adoc#absicherung_batch verwiesen.
