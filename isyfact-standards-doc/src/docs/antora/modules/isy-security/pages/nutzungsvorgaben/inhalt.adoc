...
:desc-table-parameter: Konfigurationsparameter einer Client-Anwendung
...
:desc-table-parameter: Konfigurationsparameter einer Service-Schnittstelle
[id="table-parameter-service",reftext="KonfigurationsparameterService"]
.{desc-table-parameter}
[cols="3m,2m,2m,8",options="header"]
|===
|Parameter |Wertebereich |Default |Beschreibung
...
:desc-table-parameter: Isyfact-spezifische Konfigurationsparameter einer Service-Schnittstelle
[id="table-parameter-service",reftext="KonfigurationsparameterService"]
.{desc-table-parameter}
[cols="3m,2m,2m,8",options="header"]
|===
