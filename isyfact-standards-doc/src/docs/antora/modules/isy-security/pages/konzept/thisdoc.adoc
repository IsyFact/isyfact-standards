...
Allgemeine xref:blaupausen:referenzarchitektur/master.adoc#prinzipien-der-sicherheitsarchitektur[Zentrale Sicherheitsaspekte in der Referenzarchitektur] werden im Dokument zur xref:blaupausen:referenzarchitektur/master.adoc[Referenzarchitektur] beleuchtet.
