...
Allgemeine xref:blaupausen:referenzarchitektur/master.adoc#zentrale-sicherheitsaspekte[Zentrale Sicherheitsaspekte in der Referenzarchitektur] werden im Dokument zur xref:blaupausen:referenzarchitektur/master.adoc[Referenzarchitektur] beleuchtet.
