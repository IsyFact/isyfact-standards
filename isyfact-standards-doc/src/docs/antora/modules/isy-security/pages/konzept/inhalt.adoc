...
Bei Instanziierung des Bausteins 'Security' wird die anwendungsspezifische Rollen-Rechte-Datei eingelesen, sowie der`Authentifizierungsmanager`  und der `Berechtigungsmanager` damit erzeugt.
