...
Aus der xref:blaupausen:referenzarchitektur/master.adoc#zentrale-sicherheitsaspekte[Zentralen Sicherheitsaspekten in der Referenzarchitektur] leiten sich die folgenden Randbedingungen für die Umsetzung der Berechtigungsprüfung innerhalb eines IT-Systems ab:
