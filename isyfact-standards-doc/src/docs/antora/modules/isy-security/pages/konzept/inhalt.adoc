...
*Für IsyFact-Anwendungslandschaften werden mindestens folgende zwei Tenants gefordert:*

. Tenant 1: Gruppierung aller interner und externer Systeme.
. Tenant 2: Gruppierung aller interner und externer Anwender.
