...
Im Regelfall werden diese Authentifizierungs- und Autorisierungsdaten bei der Authentifizierung der originären Anfrage über den Sicherheitsbaustein `isy-security` der Fachanwendung als initialisierten `SecurityContext` übergeben.
