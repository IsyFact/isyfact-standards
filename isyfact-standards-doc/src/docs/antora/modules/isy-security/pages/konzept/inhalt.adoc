...
Anfragen an ein IsyFact-Anwendungssystem, die von Außen eingehen, müssen über den IAM-Service authentifiziert und zur Nutzung des aufgerufenen IsyFact-Service autorisiert sein.
