...
In IsyFact spielen davon bei der Autorisierung von Anwendungsaufrufen (von intern oder extern) die beiden Verfahren _Resource-Owner-Password-Credential_ und _Client-Credential_ eine Rolle, da es sich hierbei um die Berechtigungszuteilung für ausschließlich _Confidential-Clients_ dreht.
