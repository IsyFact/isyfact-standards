...
- xref:glossary:literaturextern:inhalt.adoc#litextern-rfc7519-jwt-claims[JSON Web Token (JWT) - 4. JWT Claims]

- xref:glossary:literaturextern:inhalt.adoc#litextern-iana-json-web-token[Internet Assigned Numbers Authority: JSON Web Token (JWT)]

- xref:glossary:literaturextern:inhalt.adoc#litextern-openid-spec-claims[OpenID Connect 1.0 Specs - 5. Claims]
