...
Der Wert 'client-credentials' bedeutet, den _Credential_-Flow xref:client-credential-flow[] zu verwenden, der Wert 'password' steht für den _Credential_-Flow xref:resource-owner-password-credential-flow[]. +
