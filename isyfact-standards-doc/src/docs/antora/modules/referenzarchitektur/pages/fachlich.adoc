...
*xref:glossary::terms-definitions.adoc#glossar-geschaeftsanwendung[Geschäftsanwendung]:* Eine Geschäftsanwendung implementiert für sich genommen oder im Zusammenspiel mit anderen Geschäftsanwendungen einen oder mehrere Geschäftsprozesse einer Domäne.
...
*xref:glossary::terms-definitions.adoc#glossar-portal[Portal]:* Das Portal stellt den Benutzern eine einheitliche Dialogoberfläche für den Zugriff auf die Services der Anwendungslandschaft zur Verfügung.
...
*xref:glossary::terms-definitions.adoc#glossar-service-gateway[Service-Gateway]:* Im Service-Gateway werden alle Services der Anwendungen bereitgestellt, die externe Nutzer direkt nutzen dürfen.
