...
Die IsyFact setzt als Transportprotokoll, vor allem für das Kommunikationsmuster xref:software-technisch/kommunikation.adoc#request-reponse[Request-Response], HTTP ein.
