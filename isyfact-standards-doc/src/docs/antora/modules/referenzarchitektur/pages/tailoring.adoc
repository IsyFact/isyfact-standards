...
In einem spezifischen xref:glossary::terms-definitions.adoc#glossar-anwendungskontext[Anwendungskontext] wird man in der Regel jedoch viel weitergehende Festlegungen innerhalb der Referenzarchitektur treffen, um die Fachlichkeit des Kontexts abzubilden.
