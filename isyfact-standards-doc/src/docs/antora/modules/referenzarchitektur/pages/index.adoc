...
*xref:fachlich.adoc[]:* Sie umfasst eine fachliche Beschreibung der xref:glossary:glossary:master.adoc#glossar-anwendungslandschaft[Anwendungslandschaft].
...
*xref:software-technisch.adoc[]:* Sie umfasst die software-technische Beschreibung der xref:glossary:glossary:master.adoc#glossar-systemlandschaft[Systemlandschaft].
...
*xref:technisch-infrastrukturell.adoc[]:* Sie umfasst die Beschreibung der Systemlandschaft aus dem Blickwinkel der technischen Infrastruktur.
