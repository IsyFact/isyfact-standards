...
Als Ablaufumgebung benötigen die gemäß der xref:blaupausen:referenzarchitektur-it-system/master.adoc[Referenzarchitektur IT-System]   erstellten IT-Systeme einen Tomcat Servlet-Container.
