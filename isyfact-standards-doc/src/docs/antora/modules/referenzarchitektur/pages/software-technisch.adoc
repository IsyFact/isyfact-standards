...
Welche Maßnahmen für eine sichere Kommunikation realisiert werden, ist mit dem jeweiligen Partner, der einen xref:referenzarchitektur:software-technisch/services.adoc[Service]  anbietet, abzustimmen.
