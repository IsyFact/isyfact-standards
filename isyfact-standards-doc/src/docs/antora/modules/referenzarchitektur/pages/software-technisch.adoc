...
Der xref:referenzarchitektur:software-technisch/backend.adoc#awk-service-consumer[Sevice-Consumer] kann die Verbindung zu einem externen Service entweder unverschlüsselt per HTTP oder verschlüsselt per HTTPS aufbauen.
