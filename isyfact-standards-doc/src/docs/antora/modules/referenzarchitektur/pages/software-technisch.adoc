...
Welche Maßnahmen für eine sichere Kommunikation realisiert werden, ist mit dem jeweiligen Partner, der einen xref:referenzarchitektur:software-technisch/kommunikation.adoc[Service] anbietet, abzustimmen.
