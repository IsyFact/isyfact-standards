...
Die IsyFact-Referenzarchitektur beinhaltet auch xref:xref:software-technisch/sicherheit.adoc[Vorgaben für die Sicherheitsarchitektur] einer Systemlandschaft, die auch über den Menüeintrag "Sicherheit" zu erreichen ist.
