...
Wie genau Rollen und Rechte spezifiziert werden, beschreibt das xref: xref:security::konzept.adoc[] im Kapitel xref:security::konzept.adoc#rollen-und-rechte[Rollen und Rechte]
