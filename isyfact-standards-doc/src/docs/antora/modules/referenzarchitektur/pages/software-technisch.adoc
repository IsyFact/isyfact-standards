...
Die Geschäftsanwendungen einer Systemlandschaft können sich intern gegenseitig über ihre Service-Schnittstellen aufrufen.
...
Anwendungen können weitere Gateways erfordern, falls sie neben Services andere Dienste, zum Beispiel E-Mail-Empfang oder -Versand, für externe Systeme bereitstellen.
