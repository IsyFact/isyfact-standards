...
Stufe 3 im xref:software-technisch/services/rest.adoc#image-richard-maturity-model[Richardson Maturity Model]) oder über die URI selber abgebildet werden.
