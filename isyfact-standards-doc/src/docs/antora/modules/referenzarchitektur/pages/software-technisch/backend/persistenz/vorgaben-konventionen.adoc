...
CAUTION: Sequenzbasierte künstliche Primärschlüssel gelten ab als deprecated für neu exponierte Identifikatoren.
...
public class MyEntity {
    ...
    private long id; // ausschließlich technisch, der die Persistenzschicht nicht
