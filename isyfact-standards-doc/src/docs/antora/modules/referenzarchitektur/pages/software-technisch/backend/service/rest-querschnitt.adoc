...
Die Grundlagen der Überwachung von IsyFact-basierten Anwendungen beschreibt das xref:isy-ueberwachung:konzept/master.adoc[] beschrieben.
Detailliertere Informationen zur Konfiguration und zur Verwendung des Bausteins Überwachung finden sich in den xref:isy-ueberwachung:nutzungsvorgaben/master.adoc[], insbesondere das Kapitel xref:isy-ueberwachung:nutzungsvorgaben/master.adoc#informationen-von-services["Informationen von Services"].
