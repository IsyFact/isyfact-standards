...
Ist eine solche Steuerung trotzdem unumgänglich, muss sie über die xref:blaupausen:detailkonzept-komponente-service/inhalt.adoc#transaktionssteuerung[Serviceschicht] erfolgen.
