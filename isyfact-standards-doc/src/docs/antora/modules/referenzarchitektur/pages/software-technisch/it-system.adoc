...
Standardlösungen setzen in der Regel auf entsprechend spezialisierte Produkte.

Die Systemarchitektur beschreibt die xref:software-technisch/gateway.adoc[software-technische Referenzarchitektur für Gateways].