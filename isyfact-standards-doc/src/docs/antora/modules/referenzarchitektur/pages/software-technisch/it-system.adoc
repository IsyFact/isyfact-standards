...
include::glossary:glossary:inhalt.adoc[tag=backend-definition]
...
include::glossary:glossary:inhalt.adoc[tag=frontend-definition]
...
include::glossary:glossary:inhalt.adoc[tag=batch-definition]
