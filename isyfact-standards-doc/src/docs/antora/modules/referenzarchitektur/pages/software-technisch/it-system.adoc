...
Die Systemarchitektur und die Umsetzung querschnittlicher, technischer Aspekte für Batches beschreibt die xref:blaupausen:detailkonzept-komponente-batch/thisdoc.adoc[software-technische Referenzarchitektur für Batches].
