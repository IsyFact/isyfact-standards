...
Das Spring-Framework ist ein Java Framework, welches auf Dependency Injection und Inversion of Control basiert. Spring ist ein leichtgewichtiges Framework, welches sehr verständlich und leicht zu verwenden ist.
