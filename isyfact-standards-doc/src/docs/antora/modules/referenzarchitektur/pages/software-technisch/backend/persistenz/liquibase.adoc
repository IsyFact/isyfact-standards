...
Eine konkrete Umsetzung dieses Konzepts folgt in xref:software-technisch/backend/persistenz/liquibase-umsetzung.adoc[Nutzungsvorgaben zur Versionierung mit Liquibase] und dient als Empfehlung.
