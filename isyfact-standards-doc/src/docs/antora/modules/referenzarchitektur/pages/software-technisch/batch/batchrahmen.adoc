...
`abgebrochen`:: Der Batch is abgebrochen:
* durch einen Fehler,
...
Der Pfad der Ergebnisdatei wird über einen <<table-PropBATCanv,Konfigurationsparameter>> des Batches festgelegt. Ist dieser Parameter nicht vorhanden, so wird auch keine Ergebnisdatei geschrieben.
...
[[table-batckonfig-konfigurationsparameter-kommandozeile]]
...
[[table-batckonfig-konfigurationsparameter-konfigurationsdatei]]
...
Die Ausführungsbean führt im Rahmen dieser Transaktion das "Überlesen" der Datensätze bis zum letzten Checkpoint sowie ggf. nötige Initialisierungen durch.
...
// TODO In Batch-Dokument verschieben.
[[anforderungen]]
== Anforderungen
