...
NOTE: Siehe Unterschied zwischen _Batch-Implementierung_ und _Batch_, Kapitel <<der-unterschied-zwischen-batch-netz-batch-schritt-und-batch-implementierung>>.
