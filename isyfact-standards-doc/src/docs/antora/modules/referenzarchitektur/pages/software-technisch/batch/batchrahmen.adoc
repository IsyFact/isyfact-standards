...
|-batch
|Startet die Anwendung im Batchmodus

|-configVerzeichnis <Pfad>
|Pfad zum config Verzeichnis. Default: ./config

|-logbackCfg <Pfad>
|Pfad zur logback-batch.xml
...
|Maximale Anzahl automatischer Neustarts für einen fehlerhaft abgebrochenen Batch.
Mit Parameter `ignoriereRestart` wird Zähler auf 0 zurückgesetzt.
|====
