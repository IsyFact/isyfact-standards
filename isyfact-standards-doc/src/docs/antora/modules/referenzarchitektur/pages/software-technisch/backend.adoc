...
Details hierzu werden über die xref:software-technisch/backend/anwendungskern.adoc#verwendung-des-spring-frameworks[Vorgaben zur Verwendung des Spring-Frameworks] festgelegt.
...
include::backend/anwendungskern.adoc[tags=externer-service-definition]
