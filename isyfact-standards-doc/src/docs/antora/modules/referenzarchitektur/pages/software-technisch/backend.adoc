...
image::software-technisch/backend/architektur-backend.dn.svg[width=50%, align=center]
...
In Ausnahmefällen kann die Transaktionssteuerung auch über die xref:software-technisch/backend/service/rest-querschnitt.adoc#transaktionssteuerung[Serviceschicht] erfolgen.
...
Zur Konzeption von xref:glossary::terms-definitions.adoc#service[Services] definiert die Referenzarchitektur xref:software-technisch/kommunikation.adoc[weitere Vorgaben].
Zur Umsetzung von REST-Services mit Spring Web definiert die Referenzarchitektur xref:software-technisch/backend/serviceschicht.adoc[weitere Vorgaben].
...
image::software-technisch/backend/querschnitt.dn.svg[width=50%,align=center]
...
Monitoring::
Vorgaben und Umsetzung mithilfe des xref:ueberwachung::konzept.adoc[Bausteins Überwachung]
