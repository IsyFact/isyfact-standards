...
Unterhalb dieser Seite befinden sich weitere Inhalte zu xref:software-technisch/backend/service/rest.adoc[], Vorgaben zu xref:software-technisch/backend/service/rest-eigenschaften.adoc[], Hinweisen zur xref:software-technisch/backend/service/rest-umsetzung.adoc[] sowie xref:software-technisch/backend/service/rest-querschnitt.adoc[].
