...
Die Umsetzung der Service-Endpunkte geschieht auf Basis von REST. Hierzu finden sich in der Referenzarchitektur weitere Inhalte: zu xref:software-technisch/backend/service/rest.adoc[], Vorgaben zu xref:software-technisch/backend/service/rest-eigenschaften.adoc[], Hinweisen zur xref:software-technisch/backend/service/rest-umsetzung.adoc[] sowie zu xref:software-technisch/backend/service/rest-querschnitt.adoc[querschnittlichen Aspekten].
