...
Im Kontext von Backends geschieht die Umsetzung auf Basis einer xref:software-technisch/backend/service/openapi.adoc[]. Dazu gelten die Vorgaben zur xref:software-technisch/backend/service/rest-umsetzung.adoc[] sowie zu  xref:software-technisch/backend/service/rest-querschnitt.adoc[querschnittlichen Aspekten].
