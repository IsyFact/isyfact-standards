...
Die IsyFact sieht hierzu den Einsatz des xref:werkzeuge:openapi.adoc#openapi-generator[OpenAPI Generators] vor.
...
Mithilfe des xref:werkzeuge:openapi.adoc#openapi-generator[OpenAPI Generators] kann aus der https://swagger.io/specification/[OpenAPI-Spezifikation] AsciiDoc generiert werden.
