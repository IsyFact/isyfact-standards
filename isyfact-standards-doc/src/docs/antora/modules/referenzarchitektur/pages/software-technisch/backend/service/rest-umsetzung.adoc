...
Die IsyFact setzt grundsätzlich auf dem imperativen Programmiermodell auf und nutzen `ThreadLocal`-Mechanismen zur Propagierung von Kontext-Informationen.
...
In diesem sind Authentifizierungsinformationen, zugewiesener Rollen und Behördenkennzeichen enthalten.
