...
Ein Ausfall oder temporäre Störungen des Brokers wirken sich direkt auf die Kommunikation von weiten Teilen der Systemlandschaft aus.
...
[[publish-subscribe-betrachtung]]
==== Betrachtung der Vorteile, Herausforderungen und Risiken

Der Einsatz von Publish/Subscribe kann die Erfüllung der folgenden Qualitätskriterien fördern.

.Publish/Subscribe: Vorteile nach Qualitätskriterien (ISO 25010)
[cols="1,2", options="header"]
|===
|Qualitätskriterium
|Vorteile
...
Demgegenüber kann der Einsatz von Publish/Subscribe zu Herausforderungen und Risiken bei folgenden Qualitätskriterien führen.

.Publish/Subscribe: Herausforderungen und Risiken nach Qualitätskriterien (ISO 25010)
[cols="1,2", options="header"]
|===
|Qualitätskriterium
|Herausforderungen / Risiken
...
|Zuverlässigkeit (Reliability)
|Es ist in der Regel nicht garantiert, dass alle Subscriber eine Nachricht erhalten.
...
Nachrichten dürfen nur Information beinhalten, die alle Subscriber erhalten dürfen.

|===

[[publish-subscribe-empfehlungen]]
==== Empfehlungen zum Einsatz

Publish/Subscribe eignet sich gut, wenn es um die Verteilung von Ereignissen (englisch: _events_) an mehrere Empfänger geht.
Ereignisse übermitteln zum Beispiel Benachrichtigungen oder ZustandsänderungenFakten und benötigen keine Antwort des Subscribers.
Effiziente Umsetzungen unterstützen Multicast-Kommunikation ohne Kenntnis der Empfänger.
