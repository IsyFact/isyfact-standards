...
Message-Broker ermöglichen zudem eine Lastverteilung, sodass Instanzen des Empfängers dynamisch hinzugefügt oder entfernt werden können, um der aktuellen Last gerecht zu werden.
