...
Diese Schnittstelle wird dann durch ein xref:glossary::terms-definitions.adoc#glossar-service-gateway[Service-Gateway] in Form eines xref:software-technisch/gateway.adoc#ingress-gateway[*Ingress-Gateways*] als Webservice exportiert.
