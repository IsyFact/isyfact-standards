...
Dies geschieht mittels eines xref:glossary::terms-definitions.adoc#glossar-service-gateway[Service-Gateways].
Das Service-Gateway enthält zu diesem Zweck *Service-Provider*.
...
Dies geschieht ebenfalls mittels eines xref:glossary::terms-definitions.adoc#glossar-service-gateway[Service-Gateways].
Das Service-Gateway enthält zu diesem Zweck *Service-Consumer*.
