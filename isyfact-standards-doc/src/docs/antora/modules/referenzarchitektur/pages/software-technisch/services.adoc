...
Die Gesamtheit aller Service-Provider und Service-Consumer wird als xref:glossary:glossary:master.adoc#glossar-service-gateway[Service-Gateway] bezeichnet.
...
Die unterschiedlichen Versionen des Services verwenden alle denselben xref:glossary::terms-definitions.adoc#glossar-anwendungskern[Anwendungskern].
