...
Eine solche Abweichung von der Referenzarchitektur muss im xref:methodik:vorlage-systementwurf/antora-master.adoc[Systementwurf] in der Liste der Abweichungen aufgeführt und begründet werden.
