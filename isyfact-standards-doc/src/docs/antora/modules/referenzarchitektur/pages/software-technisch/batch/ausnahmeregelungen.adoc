...
Anhand der übergebenen Parameter, Rückgabewerte, Daten im Log darf für den Nutzer des Batches nicht erkennbar sein, dass dieser in einer anderen Technologie umgesetzt ist.
...
Ein Shell-Batch besteht aus einem Skript und ggf. weiteren Dateien:
