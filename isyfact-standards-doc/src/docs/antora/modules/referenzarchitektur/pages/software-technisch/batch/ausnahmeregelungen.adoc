...
Anhand der übergebenen Parameter, Return Codes, Daten im Log darf für den Nutzer des Batches nicht erkennbar sein, dass dieser in einer anderen Technologie umgesetzt ist.
