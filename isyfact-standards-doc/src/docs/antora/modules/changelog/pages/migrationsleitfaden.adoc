...
[WARNING]
====
Der Baustein `isy-konfiguration` ist mit der Version 3.1 als deprecated gekennzeichnet und wird nicht mehr weiter entwickelt. Er wird mit der Version 4 endgültig aus dem Projekt entfernt werden.
====
