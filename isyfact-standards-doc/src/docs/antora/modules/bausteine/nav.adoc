* xref:bausteine.adoc[]
** IsyFact-Standards
*** xref:datetime::konzept.adoc[Datum & Zeit icon:external-link-square[]]
*** Fehlerbehandlung
...
*** xref:sonderzeichen::konzept.adoc[Sonderzeichen icon:external-link-square[]]
*** xref:task::konzept.adoc[Task Scheduling icon:external-link-square[]]
*** xref:ueberwachung::konzept.adoc[Überwachung icon:external-link-square[]]
