* xref:bausteine.adoc[]
** Datum & Zeit
*** xref:datetime::konzept.adoc[Konzept]
*** xref:datetime::nutzungsvorgaben.adoc[Nutzungsvorgaben]
...
**** xref:isy-persistence:nutzungsvorgaben/versionierung-mit-liquibase.adoc[Versionierung (Liquibase)]
...
** Sonderzeichen
*** xref:sonderzeichen::konzept.adoc[Konzept]
*** xref:sonderzeichen::nutzungsvorgaben.adoc[Nutzungsvorgaben]
...
** Angular
*** xref:angular::konzept.adoc[Konzept]
