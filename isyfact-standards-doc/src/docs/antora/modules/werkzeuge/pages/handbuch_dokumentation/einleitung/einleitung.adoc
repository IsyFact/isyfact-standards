...
Das Open Source Tool Antora wird zur Generierung der HTML-Dokumentation verwendet.
...
[NOTE]
====
Einzelheiten zur Dokumentation mit Antora, u.a. zur Verzeichnisstruktur, finden sich in der xref:handbuch_dokumentation/master-antora.adoc[Dokumentation der IsyFact - Antora].
====
...
Zur Generierung der HTML- und PDF-Dokumentation werden AsciidoctorJ-Extensions verwendet.
...
[NOTE]
====
Einzelheiten zur Dokumentation mit AsciidoctorJ Extensions finden sich in der xref:handbuch_dokumentation/master-asciidoctorJ.adoc[Dokumentation der IsyFact - AsciidoctorJ Extensions].
====
