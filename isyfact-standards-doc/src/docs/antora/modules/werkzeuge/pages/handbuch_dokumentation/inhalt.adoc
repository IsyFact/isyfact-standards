...
Die Installation geht sehr einfach in wenigen Schritten und ist für Linux, Windows und Mac hier beschrieben: https://help.github.com/de/github/managing-large-files/installing-git-large-file-storage
...
`Hier ist das <<TODOHandbuch_fuer_technische_Autoren,Handbuch für technische Autoren>>.`
...
`Hier wurde ein <<TODOglossar-halloweltbeispiel, Hallo Welt Beispiel>> verwendet.`
