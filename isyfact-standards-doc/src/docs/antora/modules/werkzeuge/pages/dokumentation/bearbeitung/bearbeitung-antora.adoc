...
[IMPORTANT]
====
Das in xref:werkzeuge:dokumentation/bearbeitung/bearbeitung-asciidoctorj.adoc#tag-documents[Auftrennung von Dokumenten mit Tags] beschriebene Vorgehen mit Inhalts-Tags (`tag::inhalt[]`) ist für Seiten nicht erlaubt.
Seiten besitzen einen xref:werkzeuge:seitenvorlage.adoc#struktur-thema[engen, thematischen Fokus] und sind direkt über die xref:werkzeuge:dokumentation/erstellung/erstellung-antora.adoc#linksnavigation-antora[Linksnavigation] aufrufbar.
