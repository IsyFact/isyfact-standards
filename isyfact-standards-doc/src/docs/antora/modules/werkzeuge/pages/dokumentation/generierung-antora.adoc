...
Die Generierung einer Projektseite erfolgt, falls das Repository xref:literaturextern:inhalt.adoc#litextern-isyfact-antora[icon:github[] isy-antora-playbook] verwendet wird, wie in vergleichbaren npm-Projekten.
...
Die offizielle Antora-Dokumentation beschreibt das xref:literaturextern:inhalt.adoc#litextern-antora-playbook[Playbook].
