...
Die Generierung einer Projektseite erfolgt, falls das Repository https://github.com/IsyFact/isy-antora-playbook[icon:github[] isy-antora-playbook] verwendet wird, wie in vergleichbaren npm-Projekten.
