...
Die Generierung einer Projektseite erfolgt, falls das Repository xref:literaturextern:inhalt.adoc#litextern-isyfact-antora[icon:github[] isyfact.github.io] verwendet wird, wie in vergleichbaren npm-Projekten.
