...
****
Dieser Teil der Dokumentation ist veraltet und wird in einem zukünftigen Release angepasst.
Ab Version 4.x werden externe Verweise gemäß https://docs.asciidoctor.org/asciidoc/latest/macros/url-macro/[Asciidoc Dokumentation] gesetzt.
****
