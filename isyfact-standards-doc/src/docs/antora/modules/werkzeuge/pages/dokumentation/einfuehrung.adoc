...
* xref:glossary:literaturextern:inhalt.adoc#litextern-isyfact-antora[icon:github[] isy-antora-playbook] zur Ablage von einer globalen Konfiguration wie z.B. dem Playbook oder dem CI/CD-Build,
