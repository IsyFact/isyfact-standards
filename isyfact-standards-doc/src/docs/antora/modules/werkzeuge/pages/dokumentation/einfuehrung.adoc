...
Die Online-Dokumentation wird in xref:literaturextern:inhalt.adoc#litextern-asciidoc[AsciiDoc] verfasst.
...
Die Online-Dokumentation wird mit xref:literaturextern:inhalt.adoc#litextern-antora[Antora] generiert.
...
* xref:literaturextern:inhalt.adoc#litextern-vs-code[Visual Studio Code] zusammen mit der xref:literaturextern:inhalt.adoc#litextern-vs-code-asciidoc-erweiterung[Erweiterung für AsciiDoc],
...
* xref:literaturextern:inhalt.adoc#litextern-isyfact-antora[icon:github[] isyfact.github.io] zur Ablage der globalen Konfiguration (Playbook, CI/CD-Build, ...) und zur Bereitstellung der erzeugten Projektseite,
* xref:literaturextern:inhalt.adoc#litextern-isyfact-online-docs-meta[icon:github[] isy-documentation] zur Bereitstellung übergreifender Inhalte wie z.B. Lizenzhinweise, dem Glossar und einem Quellenverzeichnis.

Die meisten Inhalte sind derzeit im zentralen Repository xref:literaturextern:inhalt.adoc#litextern-isyfact-standards[icon:github[] isyfact-standards] enthalten.
Weitere Inhalte sind im xref:literaturextern:inhalt.adoc#litextern-isyfact-antora-playbook[Playbook] referenziert.

=== Struktur des zentralen Repositories

Die Dokumentation ist vollständig im Modul xref:literaturextern:inhalt.adoc#litextern-url-isyfact-online-docs-source[isyfact-standards-doc] enthalten.
Sie unterteilt sich in xref:literaturextern:inhalt.adoc#litextern-antora-modules[Module], die sich an den Säulen der IsyFact bzw. an ihren Bausteinen orientieren.
