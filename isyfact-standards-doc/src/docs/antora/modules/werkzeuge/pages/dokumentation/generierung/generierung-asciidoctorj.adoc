...
|siehe Seite "xref:dokumentation/erstellung/erstellung-asciidoctorj.adoc#listing-master[]"
...
|siehe Seite "xref:dokumentation/bearbeitung/bearbeitung-asciidoctorj.adoc#literaturverzeichnis[]"
...
Die Seite xref:dokumentation/erstellung/erstellung-asciidoctorj.adoc#listing-master["Neue Dokumente anlegen"] zeigt die beispielhafte Verwendung des Kolophons in einem Asciidoc Dokument.
