...
[IMPORTANT]
====
Eine knappe Zusammenfassung einer auf ein Release bezogen Änderung ist in den *Release Notes* im Changelog zu dokumentieren.

Eine Migrationsanleitung bei Breaking Changes eines Major Releases ist im *Migrationsleitfaden* im Changelog zu dokumentieren.
====
