...
. xref::entwicklungsumgebung/inhalt.adoc#virtuelle-maschine-vorbereiten[Virtuelle Maschine vorbereiten] (optional)
. benötigte xref::entwicklungsumgebung/inhalt.adoc#werkzeuge-installieren[Werkzeuge installieren] und konfigurieren
. xref::entwicklungsumgebung/inhalt.adoc#isyfact-projektgenerator-installieren[IsyFact-Projektgenerator installieren]
. xref::entwicklungsumgebung/inhalt.adoc#hello-world-anwendung-generieren[Hello-World-Anwendung generieren]
...
Wenn Sie sich bereits eine geeignete Umgebung geschaffen haben, um die Werkzeuge sowie die IsyFact-Bibliotheken zu installieren, können Sie die Vorbereitung einer virtuellen Maschine überspringen und direkt mit dem Kapitel xref::entwicklungsumgebung/inhalt.adoc#werkzeuge-installieren[Werkzeuge installieren] beginnen.
...
==== Tastaturkürzel zum Aufräumen der Imports

Sollen lediglich die Imports aufgeräumt werden, kann im Codefenster folgendes Tastenkürzel verwendet werden.
...
image::werkzeuge:entwicklungsumgebung/Einrichtung_Entwicklungsumgebung_016.png[align="center"]
...
image::werkzeuge:entwicklungsumgebung/Einrichtung_Entwicklungsumgebung_017.png[align="center"]
...
[TIP]
====
Das IsyFact-Framework besteht aus einer Reihe von xref:glossary:literaturextern:inhalt.adoc#litextern-url-isyfact-github[GitHub-Repositories], die wiederum jeweils eines oder mehrere Maven-Projekte enthalten.
====
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_bibliotheken_04.png[align="center"]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_bibliotheken_05.png[align="center",width=60%,pdfwidth=70%]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_bibliotheken_29.png[align="center",width=60%,pdfwidth=70%]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_bibliotheken_21.png[align="center",width=60%,pdfwidth=70%]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_bibliotheken_22.png[align="center",width=60%,pdfwidth=70%]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_bibliotheken_30.png[align="center"]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_bibliotheken_01.png[align="center"]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_projektgenerator_01.png[align="center",width=60%,pdfwidth=70%]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_projektgenerator_02.png[align="center",width=60%,pdfwidth=70%]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_projektgenerator_03.png[align="center",width=60%,pdfwidth=70%]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_projektgenerator_04.png[align="center",width=60%,pdfwidth=70%]
...
Selektieren Sie den im Kapitel xref::entwicklungsumgebung/inhalt.adoc#apache-tomcat[Apache Tomcat] eingerichteten Server und setzen Sie ein Häkchen bei der Checkbox "Always use this server when running this project".

.Auf Server starten
[id="image-leitfaden_entwicklungsumgebung_projektgenerator_05",reftext="{figure-caption} {counter:figures}"]
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_projektgenerator_05.png[align="center",width=60%,pdfwidth=70%]
...
image::werkzeuge:entwicklungsumgebung/leitfaden_entwicklungsumgebung_projektgenerator_06.png[align="center"]
// end::inhalt[]
