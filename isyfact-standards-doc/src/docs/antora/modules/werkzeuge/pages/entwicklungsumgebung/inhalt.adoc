...
Selektieren Sie den <<apache-tomcat,eingerichteten Server>> und setzen Sie ein Häkchen bei der Checkbox "Always use this server when running this project".
