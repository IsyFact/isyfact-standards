...
xref:literaturextern:inhalt.adoc#litextern-selenium[Selenium Dokumentation]
...
xref:literaturextern:inhalt.adoc#litextern-selenium-getting-started[Grundlegende Funktion in Selenium - Offizielle Dokumentation]
...
xref:literaturextern:inhalt.adoc#litextern-selenium-finders[Finders]

xref:literaturextern:inhalt.adoc#litextern-selenium-locators[Locators]
