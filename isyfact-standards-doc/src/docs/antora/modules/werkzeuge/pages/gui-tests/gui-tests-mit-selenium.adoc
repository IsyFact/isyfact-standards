...
xref:glossary:literaturextern:inhalt.adoc#litextern-selenium[Selenium Dokumentation]
...
xref:glossary:literaturextern:inhalt.adoc#litextern-selenium-getting-started[Grundlegende Funktion in Selenium - Offizielle Dokumentation]
...
xref:glossary:literaturextern:inhalt.adoc#litextern-selenium-finders[Finders]

xref:glossary:literaturextern:inhalt.adoc#litextern-selenium-locators[Locators]
