...
Es folgen Beispiele für seiteninterne Verweise auf <<formatierung,Überschriften>>, ein <<beispiel-abbildung>>, ein <<beispiel-tabelle>> oder ein <<beispiel-listing>>.

Interne Verweise auf andere Seiten derselben Dokumentation nutzen die xref:seitenvorlage.adoc#formatierung-verweise[Syntax des Xref-Makros von Antora].
...
****
Regeln an die Architektur von Anwendungen und IT-Systemen.
****

.icon:shield[] Sicherheit: Vorgabe
****
Regel an die Sicherheit von IT-Systemen.
****

.icon:paint-brush[] Styleguide: Vorgabe
****
Regel zur Gestaltung von grafischen Oberflächen.
****
...
....
= Titel der Seite
include::seitenvorlage.adoc[tags=attributes]
