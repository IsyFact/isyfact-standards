...
|IT-Systeme können schneller antworten und dabei Ressourcen schonen, da der Cache Datenbankzugriffe einsparen hilft. +
IT-Systeme können einer höheren Last standhalten, da der Cache Lastspitzen abfedern kann.

|Zuverlässigkeit (Reliability)
|IT-Systeme können Daten auch bei temporären Ausfällen der Datenbank, und damit zuverlässiger, liefern.
|===
