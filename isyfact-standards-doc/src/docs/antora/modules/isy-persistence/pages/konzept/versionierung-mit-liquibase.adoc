...
Mit Liquibase wird ein Industriestandard verwendet, dessen Verwendung die Zukunftsicherheit verbessert und Abhängigkeiten von Eigenentwicklungen verringert.
