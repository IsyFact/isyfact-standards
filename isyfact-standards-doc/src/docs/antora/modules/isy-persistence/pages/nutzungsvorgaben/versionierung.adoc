...
Mit den übergreifenden Skripten sollen auch die Zugriffsrechte für die Queue(s) eines IT-Systems vergeben werden, sofern diese existieren.
...
Auf diese Weise legt das IT-System selbst fest, welche anderen Systeme Zugriff auf die Queue(s) haben.
