...
Dadurch wird der Datenzugriff verlangsamt, da in diesem Fall immer zwei Tabellen statt einer geschrieben werden.
...
// TODO Fachlicher Schlüssel: Oben KANN, unten IST SO. Passt nicht ganz überein.
// TODO Woanders steht, dass zusammengesetzte Schlüssel verboten sind. Widerspruch!

[[schritt-2-erweiterung-des-daos]]
=== Schritt 2: Erweiterung des Data Access Objects

Alle Zugriffe auf Entitäten werden gemäß xref:blaupausen:detailkonzept-komponente-datenzugriff/persistenzlogik.adoc#grundlagen[Referenzarchitektur] über das zugehörige Data Access Object (DAO) vorgenommen.
...
// TODO: Verwendung der neuen API würde Calendar durch Instant ersetzen! Auch die anderen Felder wären vom Typ Instant!
