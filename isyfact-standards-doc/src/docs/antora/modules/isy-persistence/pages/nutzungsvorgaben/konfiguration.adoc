...
Es ist fallabhängig zu untersuchen, ob eine Kontrolle der Verbindung bei jedem Aufruf oder zeitgesteuert besser geeignet ist.
Oftmals ist eine Kontolle vor jeder Verbindung zu bevorzugen.
