...
Dadurch kann es trotz konsistentem Changelog zum https://www.liquibase.com/blog/database-drift[Schema-Drift] kommen.
...
Sobald alle Altversionen abgeschaltet sind, wird dann in einer dritten Phase das alte Datenbankfeld aus der Datenbank entfernt.
