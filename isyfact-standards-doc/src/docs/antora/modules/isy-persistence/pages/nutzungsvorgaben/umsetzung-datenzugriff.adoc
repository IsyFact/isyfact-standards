...
Gemäß der xref:blaupausen:referenzarchitektur-it-system/inhalt.adoc#datenzugriff[Referenzarchitektur] dürfen Entitäten nur von der Fachkomponente im Anwendungskern verändert werden, welche zur Fachkomponente im Datenzugriff gehört.
