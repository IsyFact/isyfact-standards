...
Das Konzept JPA/Hibernate konkretisiert die xref:referenzarchitektur:software-technisch/backend/persistenzschicht.adoc[Vorgaben aus der Referenzarchitektur] bezüglich des Datenzugriffs und bietet eine architektonische Lösung auf Basis des O/R-Mappers Hibernate.
