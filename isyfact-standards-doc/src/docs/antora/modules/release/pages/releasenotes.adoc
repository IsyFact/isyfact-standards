...
Die Begrifflichkeiten wurden glattgezogen und an Industriestandards angepasst. Die wesentlichen Begriffe und ihr Zusammenhang sind nun: xref:referenzarchitektur:software-technisch/batch.adoc[_Batches_] werden als _Batch-Schritte_ eines _Batch-Jobs_ von einer _Batch-Steuerung_ aufgerufen.
