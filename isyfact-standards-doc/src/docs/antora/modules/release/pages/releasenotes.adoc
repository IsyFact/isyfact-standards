...
Dies gilt für den Einsaz eines xref:isy-persistence:konzept/vorgaben-konventionen.adoc#second-level-cache[Second-Level-Caches] sowie von xref:isy-persistence:konzept/vorgaben-konventionen.adoc#bulk-queries[Bulk Queries].
