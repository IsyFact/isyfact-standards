...
Der Baustein bietet ein erweitertes xref:referenzarchitektur:software-technisch/backend/persistenz/liquibase.adoc[Konzept] sowie xref:isy-persistence:nutzungsvorgaben/versionierung-mit-liquibase.adoc[Nutzungsvorgaben] zur Schema-Versionierung mit Liquibase.
