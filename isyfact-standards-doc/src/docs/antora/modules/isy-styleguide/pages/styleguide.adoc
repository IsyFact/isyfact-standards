...
Der Styleguide definiert den Rahmen für die interaktive und visuelle Gestaltung eines universell einsetzbaren Bedienkonzeptes für die IsyFact.
Dieses einführende Kapitel beinhaltet allgemeine Hinweise zur Benutzung des Styleguides.
...
Da in einem Styleguide generische Regeln und nicht detaillierte GUI-Spezifikationen für jeden Screen einer Applikation festgelegt werden, ist es beim Screen Design notwendig, große Sorgfalt walten zu lassen.
...
*_Zielgruppe des Styleguides_*

Der Styleguide richtet sich in erster Linie an Produktverantwortliche, Software-Entwickler und User Interface Designer.
Einen Überblick über die gestalterischen Grundlagen des Systems liefert der Styleguide aber auch für Marketing-Experten und die Verantwortlichen des Corporate Design.
Alle Teile des Styleguides sind erweiterbar und sollten über die Zeit hinweg fortgeschrieben und ergänzt werden.
...
Styleguides gewährleisten ein einheitliches Look & Feel von Applikationen und schaffen so die Voraussetzungen dafür, dass Benutzern eine schnelle Einarbeitung in Logik, Ablauf und Funktionsweise einer Anwendung und eine befriedigende Arbeit ermöglicht wird.
Neben der Vereinheitlichung und der damit verbundenen Erhöhung der Benutzerfreundlichkeit liegt ein wesentlicher wirtschaftlicher Vorteil eines Styleguide in der Steigerung der Effizienz, da er Lösungen für wiederkehrende Aufgabenstellungen innerhalb einer Applikation bzw.
eines Applikationspakets bietet.
Der vorliegende Styleguide definiert den Rahmen für die interaktive und visuelle Gestaltung eines universell einsetzbaren Bedienkonzeptes.
...
[[image-negativarbeitsgedaechtnis]]
...
[[image-gruppierungbereiche]]
.Gruppierung zusammengehöriger Bereiche wird unnötig belastet
...
Im Rahmen des World Wide Web Consortium (W3C) wurden die sogenannten „Web Content Accessibility Guidelines“ (https://www.w3.org/WAI/standards-guidelines/wcag/[WCAG]) verfasst, um einen gemeinsamen Standard für die Barrierefreiheit von Webinhalten zu schaffen.
...
Als Teil dieses Gesetzes wurde die sogenannte Barrierefreie-Informationstechnik-Verordnung (https://www.gesetze-im-internet.de/bitv_2_0/BJNR184300011.html[BITV]) verfasst.
...
Die https://www.gesetze-im-internet.de/bitv_2_0/BJNR184300011.html[BITV] wendet als Grundlage die Prinzipien und Richtlinien der https://www.w3.org/WAI/standards-guidelines/wcag/[WCAG] an.
...
* Firefox ESR, jeweils aktuelle Version (xref:glossary:literaturextern:inhalt.adoc#litextern-firefox-esr[Firefox Extended Support Release [ESR]])
...
[[image-virtuellesraster]]
.Virtuelles Raster – Beispiel Dashboard unnötig belastet
...
[[image-grupphilfhintergrund]]
.Gruppierungen mit Hilfe von Hintergründe
image::Gruppierung_Hintergrundfarbe.png[align="center", width="500",height="104"]

[[image-grupphilfabstand]]
...
image::hauptfenster-aufbau.png[align="center", width="650"]
...
[[beschraenkung-auf-einen-browser-tab]]
...
image::Header_Aufbau.png[align="center", width="700"]
