...
Bei der Erstellung der Webseiten nach diesem Bedienkonzept muss die korrekte Darstellung und Funktionsweise der Webseiten geprüft werden.
...
* Generell sollten beim Layout eines Screens keine horizontalen Scrollbalken verwendet werden.
* Bei einer Seitenbreite zwischen *1280px* und *1920px* gelten folgende Richtlinien
** Es sollen keine vertikalen Scrollbalken angezeigt werden.
