...
* Die Seite enthält eine Seiten-Toolbar, deren Funktion es ermöglicht zwischen einzelen Detailseite einer Trefferliste und zurück zu Trefferliste zu navigieren.
...
* Das Navigieren zwischen den Ergebnissen muss auch über die Standard Browser-Funktionalität möglich sein
