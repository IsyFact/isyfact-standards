...
In diesem Kapitel werden spezielle Bedienelemente besprochen und allgemeine Eigenschaften der Bedienelemente beschrieben.
...
Nicht relevante Komponenten können deaktiviert werden, sodass der Benutzer sie zwar sehen, jedoch nicht bedienen kann.
Alternativ können nicht relevante Informationen und Komponenten ausgeblendet werden, sodass der Benutzer sie nicht sehen kann.

*Ausblenden nicht relevanter Elemente*
Elemente, die *dauerhaft* nicht relevant sind, sollten ausgeblendet werden, sodass sie für den Benutzer nicht sichtbar sind.
...
* Ein Benutzer A hat Daten geändert, die gemäß dem 4-Augen-Prinzip bestätigt werden müssen.
...
Die ursprünglichen Werte wurden nicht überschrieben, sodass sie im Falle einer Ablehnung der Änderung wiederhergestellt werden können.
...
* Die initiale oder fixe Breite von Spalten muss sich an der zu erwartenden Maximalwortlänge orientieren.
