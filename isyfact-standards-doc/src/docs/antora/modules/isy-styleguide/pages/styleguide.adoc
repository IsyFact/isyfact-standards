...
*** Ein Rücksprung auf die Liste der Objekte soll nicht enthalten sein, da es dafür den Zurück-Button in jedem unterstützen Browser gibt.
...
* Seiten-Toolbar *(B)*
** Die Seiten-Toolbar zeigt Funktionen, welche für die gesamte Seite gelten z.B. „Seite drucken", „Hilfe", mehr Informationen siehe Kapitel Toolbar.
