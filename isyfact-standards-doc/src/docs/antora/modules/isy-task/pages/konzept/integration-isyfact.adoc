...
NOTE: Mehr zu der Annotation `@Timed` findet sich in der xref:literaturextern:inhalt.adoc#litextern-micrometer-timed-annotation[Dokumentation von Micrometer].
