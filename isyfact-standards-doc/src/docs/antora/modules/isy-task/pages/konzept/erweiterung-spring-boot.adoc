...
NOTE: Mehr Informationen zu dem Thema finden sich in der https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.task-execution-and-scheduling[Dokumentation über Task Scheduling von Spring Boot] sowie in der https://docs.spring.io/spring-framework/docs/5.3.26-SNAPSHOT/reference/html/integration.html#scheduling-annotation-support[Dokumentation über die Annotationen zum Scheduling des Spring Frameworks].
...
NOTE: Mehr Informationen zu Around Advices (und zu Spring AOP) finden sich in der https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/core.html#aop-ataspectj-around-advice[Dokumentation des Spring Frameworks].
