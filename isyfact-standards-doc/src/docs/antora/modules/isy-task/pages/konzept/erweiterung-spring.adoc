...
NOTE: Mehr Informationen zu dem Thema finden sich in der xref:literaturextern:inhalt.adoc#litextern-spring-boot-task-scheduling[Dokumentation über Task Scheduling von Spring] sowie in der xref:literaturextern:inhalt.adoc#litextern-spring-task-scheduling-annotations[Dokumentation über die Annotationen zum Scheduling des Spring Frameworks].
...
NOTE: Mehr Informationen zu Around Advices (und zu Spring AOP) finden sich in der xref:literaturextern:inhalt.adoc#litextern-spring-aop-aspectj-around-advice[Dokumentation des Spring Frameworks].
