...
Checkboxen sind ein wesentliches Element der Benutzeroberfläche, das in vielen Frontends verwendet wird.
...
Dies ist besonders wichtig, um sicherzustellen, dass alle Nutzenden, einschließlich derjenigen mit Behinderungen, das Frontend problemlos nutzen können.
...
Radiobuttons sind ein wesentliches Element der Benutzeroberfläche, das in vielen Frontends verwendet wird.
