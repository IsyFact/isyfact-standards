...
* Gleiche Bedeutungen mit unterschiedlichen Icons entsteht (Beispiel: Warenkorb = Einkaufwagen und Beutel), hier wird die von Prime Faces vorgegeben Lösung genutzt.
