...
=== Schriften
*Anwendung*
Anwendungen des Bundes sollen über die IT-Landschaft hinweig ein einheltiches Look & Feel bieten, dies wird über die Anwenundg der ISYFact und deren Komponenten gewährleistet. Dazu ist es zudem notwendig auch bei der Schrift (im weiteren Font)
einheitlich vorzugehen. Zur Anwendung kommt primär:
*BundesSans
...
Basierend auf UNICODE wurde für jedes Nicht-Lateinische Zeichen, dass in EU Mitgliedsstaaten verwendet wird (bspw. griechische oder kyrillische Zeichen), eine eindeutige Zuordnung zu einem lateinischen Zeichen vorgenommen. DIN 91379 wendet sich vorrangig an Behörden und Organisationen, die IT-Verfahren betreiben, welche dem behördenübergreifenden Datenaustausch oder dem Datenaustausch mit Bürgern und Wirtschaft dienen. Sie deckt in ihrer Gesamtheit die EU-Amtssprachen und die Amtssprachen Islands, Liechtensteins, Norwegens und der Schweiz sowie die deutschen Minderheitensprachen ab.
Damit dies gewährleistet wird, kommt sekundär:
*Liberation
zum Einsatz. Diese Schriftart wird nur fehlende UNICODE zeichen in der BundesSans ergänzen, wodurch eine unkonformität mit der BITV durch evtl. Verwechslungen mit einem großen I und kleinen l ausgeschlossen werden kann. In diesem konkreten Beispiel kommt die BundesSans zum tragen.

*Barrierefreiheit*
Zusätzlich zu einem klar leserlichen Schriftschnitt sind auch die Gestaltungsmerkmale von Text, Farbe und Größe entsprechend zu berücksichtigen. Die Standard-Schriftart für Bedienelemente und Inhalte ist BundesSans 14 pt regular in Dunkelgrau.  
Grundsätzlich gilt susreichende Schriftgrößen sind abhängig vom Betrachtungsabstand, von der Art des Textes und von der Sehschärfe der Lesenden. Individuelle Schriftgrößen können Sie mit dem Schriftgrößenrechner auf leserlich.info ermitteln und entsprechend dem Nutzerkreis anpassen.
...
*  Es muss sichergestellt sein, dass der Kontrast der Schriftfarbe zur Hintergrundfarbe ausreichend groß ist. Hier ist der Kontrast größtmöglich zu wählen (z.B. Dunkelgraue Schrift auf weißen Hintergrund), ist dies nicht aus technischer oder fachlicher Notwendigkeit nicht möglich, so muss der Kontrast kleiner Schrift mindestestens 4:1 entsprechen, Überschriften und großer/dicker Text muss mindestens einen Kontrast von 3:1 aufweisen.
