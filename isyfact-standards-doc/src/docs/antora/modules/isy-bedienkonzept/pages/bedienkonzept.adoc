...
=== Schriften
*Anwendung*
Anwendungen des Bundes sollen über die IT-Landschaft hinweig ein einheltiches Look & Feel bieten, dies wird über die Anwenundg der ISYFact und deren Komponenten gewährleistet.
...
Die BundesSans ist eine Humanistische Serifenlose Schrift, Rationalität und äußerste Klarheit kennzeichnen ihre Formensprache.
...
Basierend auf UNICODE wurde für jedes Nicht-Lateinische Zeichen, dass in EU Mitgliedsstaaten verwendet wird (bspw. griechische oder kyrillische Zeichen), eine eindeutige Zuordnung zu einem lateinischen Zeichen vorgenommen.
...
Sie deckt in ihrer Gesamtheit die EU-Amtssprachen und die Amtssprachen Islands, Liechtensteins, Norwegens und der Schweiz sowie die deutschen Minderheitensprachen ab.
Damit dies gewährleistet wird, kommt sekundär:
*Liberation*
zum Einsatz.
Diese Schriftart wird nur fehlende UNICODE zeichen in der BundesSans ergänzen, wodurch eine unkonformität mit der BITV durch evtl. Verwechslungen mit einem großen I und kleinen l ausgeschlossen werden kann.
...
Grundsätzlich gilt susreichende Schriftgrößen sind abhängig vom Betrachtungsabstand, von der Art des Textes und von der Sehschärfe der Lesenden.
...
Hier ist der Kontrast größtmöglich zu wählen (z.B. Dunkelgraue Schrift auf weißen Hintergrund), ist dies aus technischer oder fachlicher Notwendigkeit nicht möglich, so muss der Kontrast kleiner Schrift mindestestens 4:1 entsprechen, Überschriften und großer/dicker Text muss mindestens einen Kontrast von 3:1 aufweisen.
...
xref:glossary:literaturextern:inhalt.adoc#litextern-prime-faces-icons[Prime Faces Icons]
