...
* Sobald ein Eingabefeld fokussiert wird oder eine Eingabe enthält, sollte das Floating-Label sich nach oben bewegen, an den oberen Rand des Eingabefeldes. Dies signalisiert dem Benutzer, dass das Feld aktiv ist und erleichtert die Zuordnung von Label und Eingabefeld.
...
* Der vertikale Abstand zwischen Gruppen von Formularinhalten bleibt unabhängig von der Bildschirmgröße konstant.
