...
Um die Grundlage für automatische Tests (Einsatz von Test-Frameworks) von Bedienelementen einer Web-basierenden Anwendung zu schaffen, sollten allen Maskenobjekten im HTML-Sourcecode eindeutige IDs zugeordnet sein.
...
*** https://www.leserlich.info/kapitel/farben.php[leserlich.info]
...
* Auf der Webseite
https://www.vischeck.com/[Vischeck]
...
Der Einsatz von Icons in Anwendungen soll einem einheitlichen Stil folgen und sich primär an Icons der Bibliothek https://www.primefaces.org/showcase/icons.xhtml[Prime Faces Icons] bedienen.
...
Eine Gesamtübersicht der zur Verfügung stehenden Icons ist auf https://www.primefaces.org/showcase/icons.xhtml[Prime Faces Icons] zu finden.
