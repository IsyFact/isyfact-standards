...
*_Zielsetzung des Bedienkonzeptes und Abgrenzung zum Bedienkonzept_*
...
Jede Toast-Notification muss eine Schließen-Aktion für den Benutzer anbieten und muss mindestens 3 Sekunden sichtbar bleiben.
Die Zeit bis zum automatischen Ausblenden kann je nach Anwendungsfall verlängert werden (z.B. lange Texte zum Lesen).
Alternativ kann die Toast-Notification auch dauerhaft eingeblendet bleiben, bis der Benutzer sie schließt.
...
xref:glossary:literaturextern:inhalt.adoc#litextern-font-awesome-icons[Font Awesome Icons]
