...
Tabellen Zeilen sind standardmäßig nicht anwählbar, was aber durch eine fachliche Notwendigkeit umgesetzt werden kann.
...
[IMPORTANT]
Wichtig ist es das Verhalten der Tabelle innerhalb der Anwendung konsistent zu halten.
...
* Die Tabelle wird initial mit den ersten 10 oder 20 Zeilen angezeigt und nach Klick auf den Button werden die nächsten 9 oder 19 Items nachgeladen.
Sodass man erkennt, das man genau am Ende des letzten Eintrags weitermacht.
