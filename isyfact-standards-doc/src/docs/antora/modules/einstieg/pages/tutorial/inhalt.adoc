...
Dies kann notwendig sein, wenn ein Zugriff auf Daten notwendig ist, die noch nicht über eine querschnittliche Bibliothek oder einen Querschnittsservice (z.B. Schlüsselverzeichnis) angeboten werden.
