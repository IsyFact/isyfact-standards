...
* DAOs und Entitätsklassen werden in einer bestimmten Packetstrucktur abgelegt (siehe xref:blaupausen:detailkonzept-komponente-datenzugriff/master.adoc#_detailkonzept_datenzugriff_einleitung[Detailkonzept Komponente Datenzugriff]).
