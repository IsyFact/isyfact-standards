...
Eine Beschreibung der Parameter ist im xref:blaupausen:detailkonzept-komponente-batch/inhalt.adoc#standard-konfigurationsparameter[Batchrahmen] enthalten.
