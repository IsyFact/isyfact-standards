...
erweitert werden, sodass Aufrufe bei Timeouts wiederholt werden.
...
Ein Klassendiagramm ist in <<TODO anderes Dokument: ProtokollierungKonzept>> enthalten.
...
* Die Authentifizierung von Anfragen wird im Servicegateway und im Portal mithilfe des Access Managers durchgeführt.
