...
Die vorgegebenen, bzw. empfohlenen Produkte sind, zusammen mit weiteren Informationen zum xref:produktkatalog/erlaeuterungen.adoc[Lebenszyklus], falls möglich ihren jeweiligen Technologiestacks zugeordnet:

* xref:produktkatalog/produktvorgabenAllgemein.adoc[Allgemeine Produktvorgaben]
* xref:produktkatalog/technologiestackJavaSpring.adoc[Technologiestack Java/Spring]
* xref:produktkatalog/technologiestackTypescriptAngular.adoc[Technologiestack Typescript/Angular]

In der xref:produktkatalog/negativliste.adoc[Negativliste] sind Produkte oder Produktversionen beschrieben, welche nicht zu verwenden sind.
