...
[[isyfact-aufbau]]
.Aufbau der IsyFact
image::einstieg:einstieg/isyfact-aufbau.svg[]
...
image::einstieg/isyfact-saeulen.svg[]
...
[[isyfact-marktplatz]]
.Mitarbeit an der IsyFact
image::einstieg/isyfact-marktplatz.svg[]
...
Der Teil enthält außerdem das xref:tutorial/master.adoc#einleitung[Tutorial], grundlegende Dokumente wie den <<TODO anderes Dokument: ProduktKatalog>> und die <<TODO anderes Dokument: Aenderungshistorie>> sowie die Beschreibungen der Referenzarchitektur.
...
Die <<TODO anderes Dokument: NutzungsvorgabenSessionManagement>> zeigen, wie mithilfe dieser Erweiterung Sessions in IsyFact Anwendungen verwaltet werden.
