...
:desc-image-IFBereiche: Die 5 Säulen der IsyFact
[id="image-IFBereiche",reftext="{figure-caption} {counter:figures}"]
.{desc-image-IFBereiche}
image::../../common/images/IFBereiche.png[align="center",width=60%,pdfwidth=60%]
...
Darüber hinaus existiert eine <<Vorlageanwendung>>, die eine einfache Geschäftsanwendung („Terminfindung“) auf Grundlage der IsyFact implementiert.
...
Dazu wird der HTTP-Invoker von Spring verwendet. Details sind zu finden unter <<Konzept_HttpInvoker>>.
