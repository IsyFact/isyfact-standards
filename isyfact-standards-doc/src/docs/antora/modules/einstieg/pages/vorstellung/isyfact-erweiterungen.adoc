...
[[bedienkonzept]]
=== Bedienkonzept
Der Baustein Bedienkonzept beschreibt die Gestaltung grafischer Oberflächen nach einheitlichen Gesichtspunkten.
Das zentrale Dokument, der xref:isy-bedienkonzept:bedienkonzept.adoc[Bedienkonzept], enthält Vorgaben zu Aufbau und Gestaltung von Web-GUIs.
Das Bedienkonzept definiert ebenfalls Form und Funktion der in der IsyFact verfügbaren Anzeige- und Bedienelemente.
