...
Der Teil enthält außerdem das xref:tutorial/master.adoc[Tutorial], das xref:whitepaper/inhalt.adoc[Whitepaper] und den xref:migrationsleitfaden-if2/master.adoc[Migrationsleitfaden zur IsyFact 2].
