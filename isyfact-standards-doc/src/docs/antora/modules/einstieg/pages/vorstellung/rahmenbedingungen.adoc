...
Die Dokumentation der IsyFact folgt einer festgelegten Struktur, die unter xref:methodik:vorgaben-dokumentation.adoc[Vorgaben zur Dokumentation] erläutert sind.