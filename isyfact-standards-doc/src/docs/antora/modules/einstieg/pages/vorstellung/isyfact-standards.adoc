...
Weitere Details zum Aufbau und zur Umsetzung von Batches enthält die xref:blaupausen:detailkonzept-komponente-batch/thisdoc.adoc[software-technische Referenzarchitektur für Batches].
