...
Die xref:referenzarchitektur:index.adoc[] definiert die Architektur einzelner Anwendungssysteme bis hin zu Anwendungslandschaften.
...
Die Grundlagen der TI-Architektur auf Ebene von Anwendungslandschaften und Anwendungssystemen ist in der xref:referenzarchitektur:technisch-infrastrukturell.adoc[technisch-infrastrukturellen Referenzarchitektur] beschrieben.
