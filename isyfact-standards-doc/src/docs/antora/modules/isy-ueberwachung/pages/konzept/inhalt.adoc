...
So wird für Informationen über den Systemzustand die Endpoints `health`, `livenessState`, `readinessState` angeboten und über den Endpoint `metrics` können Metriken gelesen werden.
