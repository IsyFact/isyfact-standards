...
:desc-listing-info-maven-config: Maven Konfiguration für Build- und GIT Informationen
[id="listing-info-maven-config",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-info-maven-config}
[source,xml]
----
<plugin>
...
:desc-listing-task-activation: Properties zur Aktivierung des Tasks
[id="listing-task-activation",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-task-activation}
----
...
:desc-listing-endpointconfig-defaults: Properties zur Konfiguration der Endpoints
[id="listing-endpointconfig-defaults",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-endpointconfig-defaults}
----
...
:desc-listing-nachbarsysteme: Konfiguration des NachbarsystemIndicators
[id="listing-nachbarsysteme",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-nachbarsysteme}
----
...
:desc-listing-Pruefmethode: Demonstration Future-Pattern
