...
Ohne Konfiguration von Benutzername und Passwort bleibt die Absicherung aktiv und es kann auf keine Endpoints zugegriffen werden,
außer dem Health-Endpoint, welcher nicht abgesichert ist.
