...
<<table-StdueberServ>> zeigt eine Liste der zu überwachenden bzw. anzubietenden Informationen für die xref:glossary::terms-definitions.adoc#service[Services] von Anwendungen.
...
NOTE: Weiterführende Informationen enthält die https://docs.spring.io/spring-boot/api/rest/actuator/info.html[Dokumentation von Spring Boot zum Info-Endpoint].
...
im Klassenpfad verfügbar sind. D.h. hier muss ein Token mitgeschicket werden. das auf Gütligkeit geprüft wird.
...
[[implementierung-von-pruefmethoden]]
