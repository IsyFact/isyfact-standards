...
Die Ping-Methode dieses Beans kann zur Implementierung eines Health-Indikators verwendet werden. Z. B.
...
NOTE: Bei der Erstellung des AdministrationRemoteBean sollte der Request-Timeout gesetzt werden, damit Ressourcen nicht zu lange blockiert werden.
