...
Mithilfe des OpenAPI Generators kann aus der xref:glossary:literaturextern:inhalt.adoc#litextern-openapi-spezifikation[OpenAPI Spezifikation] (YAML Datei) AsciiDoc generiert/erstellt werden.
