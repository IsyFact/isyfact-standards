...
Mithilfe des OpenApi Generators kann aus der xref:glossary:literaturextern:inhalt.adoc#litextern-openapi-spezifikation[OpenAPI Spezifikation] (YAML Datei) EXTERNER_LINK AsciiDoc generiert/erstellt werden.
...
Es wird eine Integration in den Antora-Build verwendet, weil:
