...
Wir empfehlen das entsprechende IntelliJ und Eclipse Plugins dieses Editors (siehe xref:literaturextern:inhalt.adoc#litextern-swagger-editor-intellij[Swagger Editor für IntelliJ] und xref:literaturextern:inhalt.adoc#litextern-swagger-editor-eclipse[Swagger Editor für Eclipse]).
...
Weitere Informationen zu OpenAPI 3.0 (Beschreibung und Vorgaben) finden Sie unter xref:literaturextern:inhalt.adoc#litextern-swagger-spezification[Swagger Spezifikation]).
...
Mithilfe des OpenAPI Generators kann aus der xref:literaturextern:inhalt.adoc#litextern-openapi-spezifikation[OpenAPI Spezifikation] (YAML Datei) AsciiDoc generiert/erstellt werden.
...
Nach abgeschlossener Bearbeitung werden die Korrelations-IDs durch https://isyfact.github.io/isyfact-standards-doku/current/isy-logging/nutzungsvorgaben/master.html#mcdfilter[MDC-Filter] und https://github.com/IsyFact/isyfact-standards/blob/release/3.x/isy-logging/src/main/java/de/bund/bva/isyfact/logging/http/HttpHeaderNestedDiagnosticContextFilter.java#L113[HttpHeaderNestedDiagnosticContextFilter] oder https://github.com/IsyFact/isyfact-standards/blob/release/3.x/isy-task/src/main/java/de/bund/bva/isyfact/task/monitoring/IsyTaskAspect.java#L163[IsyTaskAspect] / https://github.com/IsyFact/isyfact-standards/blob/release/3.x/isy-batchrahmen/src/main/java/de/bund/bva/isyfact/batchrahmen/core/rahmen/impl/BatchrahmenImpl.java#L269[BatchrahmenImpl] entfernt.
