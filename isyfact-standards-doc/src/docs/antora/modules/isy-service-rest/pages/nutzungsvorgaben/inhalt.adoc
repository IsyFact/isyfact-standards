...
Nähere und detailliertere Informationen dazu befinden sich unter dem Kapitel <<Verwendung_von_OpenAPI_Generator,Kapitel>>.
...
Der Build Prozess ist im Repository *_isy-antora-playbook_* implementiert und dokumentiert.
...
Somit können technische Benutzer Zugriff auf die technischen Schnittstellen-Spezifikationen im OpenAPI-Standard erhalten.
