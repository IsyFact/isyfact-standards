...
//ToDo: Ist der Antora Baustein OS?
Für die Integration der generierten AsciiDoc-Dateien in den Antora-Dokumentenbuild verweisen wir auf die Antora Nutzungsvorgaben.
