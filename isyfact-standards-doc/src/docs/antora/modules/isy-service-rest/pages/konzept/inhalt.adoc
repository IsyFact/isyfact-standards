...
[NOTE]
====
Details zur Implementierung können der xref:glossary:literaturextern:inhalt.adoc#litextern-spring-webflux[offiziellen Spring Dokumentation] entnommen werden.
====
...
[NOTE]
====
Nähere Informationen zu OAuth2 gibt es auf der xref:glossary:literaturextern:inhalt.adoc#litextern-oauth-homepage[OAuth Homepage].
