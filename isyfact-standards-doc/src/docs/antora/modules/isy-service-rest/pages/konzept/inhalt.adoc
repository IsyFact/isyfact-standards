...
[NOTE]
====
Einen guten Überblick und Verweise auf detailliertere Beschreibungen bietet die xref:glossary:literaturextern:inhalt.adoc#litextern-wiki-rest[Wikipedia-Seite zu REST].
Für einen tiefen Einstieg in die Grundlagen bietet sich die xref:glossary:literaturextern:inhalt.adoc#litextern-dissertation-roy-fielding[Dissertation von Roy Fielding] an.
====
...
image::isy-service-rest:konzept/richard-maturity-model.dn.png[align = center, title-align=center]
...
.icon:university[] Architekturvorgabe
****
...
----
Beispiel: /auskunft/personaliensuche
Beispiel: /auskunft/dokumentensuche
Beispiel: /auskunft/schluesselsuche
Beispiel: /meldung/erstmeldung
Beispiel: /meldung/aenderung
----
...
----
Beispiel: /kunden/12345/bestellungen/123/artikel
----
...
NOTE: Eine Übersicht über die HTTP-Methoden und ihre Eigenschaften, findet sich in xref:konzept/anhaenge.adoc#anhang-http-methoden[Anhang: http-Methoden]
...
[NOTE]
====
Für die Auswahl weiterer Statuscodes bietet die entsprechende xref:glossary:literaturextern:inhalt.adoc#litextern-wikipedia-http-statuscode[Wikipedia-Seite zu HTTP-Statuscodes] einen guten Startpunkt.
Empfehlenswert ist außerdem diese gut strukturierte Übersicht von xref:glossary:literaturextern:inhalt.adoc#litextern-restapitutorial-uebersicht-http-statuscodes[openapi-generator.tech], die Informationen von Wikipedia und des IETF übersichtlich aufbereitet.
====
...
[NOTE]
====
Weitere Details zu Content Negotiation bietet die entsprechende xref:glossary:literaturextern:inhalt.adoc#litextern-spring-content-negotiation[Spring Wikipedia-Seite].
====
...
Für die häufigsten Repräsentationen legt xref:konzept/anhaenge.adoc#anhang-content-types[Anhang: Content types] die erwarteten und zurückgegebenen Inhaltstypen fest.
...
NOTE: Eine Übersicht, welche HTTP-Methoden Caching-Fähig sind, findet sich unter xref:konzept/anhaenge.adoc#anhang-http-methoden[Anhang: http-Methoden]
...
////
|OpenAPI Generator
|diverse Technologien werden unterstützt, darunter Java/Spring und Angular. Eine vollständige Liste ist unter xref:glossary:literaturextern:inhalt.adoc#litextern-openapi-generator-tech[openapi-generator.tech] verfügbar.
...
//Alternativ kann auch der Editor unter xref:glossary:literaturextern:inhalt.adoc#litextern-openapi-generator-tech[openapi-generator.tech] verwendet werden, _OpenAPI 3.x_ wird hier ebenfalls unterstützt.
...
Der xref:glossary:literaturextern:inhalt.adoc#litextern-swagger-request-validator[Swagger Request Validator] hat keine weiteren Abhängigkeiten und kann somit unabhängig von HTTP APIs oder Frameworks verwendet werden.
...
[NOTE]
====
Details zur Implementierung können der xref:glossary:literaturextern:inhalt.adoc#litextern-spring-webflux-exceptions[offiziellen Spring Dokumentation] entnommen werden.
====
...
[NOTE]
====
Nähere Informationen zu OAuth2 gibt es auf der xref:glossary:literaturextern:inhalt.adoc#litextern-Git-LFS[OAuth Homepage].
.

Informationen zur Bearer Propagation gibt es in der xref:glossary:literaturextern:inhalt.adoc#litextern-spring-oauth2-bearertoken-resolver[offiziellen Spring Dokumentation].
====

Um eine Klasse oder einzelne Methoden zu sichern, ist die `@Gesichert` Annotation des Bausteins Sicherheit zu verwendet.

Generell ist das xref:isy-sicherheit:konzept/master.adoc#einleitung[Konzept Sicherheit] zu beachten.
