= Konzept Umgang mit Sonderzeichen: Inhalt
...
* Nach Erlass des BMI ist für das Personenstands,- Melde- und Ausländerwesen die Verarbeitung sämtlicher Zeichen gem. https://www.owasp.org/index.php/Category:OWASP_Top_Ten_Project[OWASP Top 10 Project] vorgegeben.
Weder mehr noch weniger Zeichen darf/muss das System verarbeiten können.

[[festlegung-des-zeichensatzes-und-der-codierung]]
== Festlegung des Zeichensatzes und der Codierung

Laut der https://www.cio.bund.de/SharedDocs/Publikationen/DE/Architekturen-und-Standards/architekturrichtlinie_it_bund_techn_spezif_2020.pdf[Architekturrichtlinie für die IT des Bundes - Technische Spezifikation zur Architekturrichtlinie (Version 2020)] soll der Zeichensatz DIN SPEC 91379 (auch String.Latin 1.2) in der UTF-8-Codierung verwendet werden.
...
Gemäß den Anforderungen des String.Latin Zeichensatzes des BMI https://www.owasp.org/index.php/Category:OWASP_Top_Ten_Project[OWASP Top 10 Project] soll die IsyFact genau diesen Zeichensatz unterstützen.
...
Für nach xref:glossary:glossary:master.adoc#glossar-IFS[IsyFact Standards (Glossar)] entwickelte Anwendungen ist der zu verwendende Zeichensatz festgelegt.
...
image::sonderzeichen_klasse_transtext.png[pdfwidth=35%,width=35%,align="center"]
...
image::sonderzeichen_transkription.png[pdfwidth=50%,width=50%,align="center"]
