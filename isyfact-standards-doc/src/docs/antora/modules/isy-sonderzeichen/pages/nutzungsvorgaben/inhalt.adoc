...
Die Standard-Zeichencodierung aller in der xref:glossary:glossary:master.adoc#glossar-Plattform[Plattform (Glossar)] verwendeten Betriebssysteme muss einheitlich auf die Verwendung von Unicode v4.x in der UTF-8-Codierung gesetzt werden.
