...
Der Baustein `isy-sonderzeichen` ist eine Querschnittsanwendung, die anderen Anwendungen Services zur Transformation und Validierung von Zeichenketten zur Verfügung stellt.
