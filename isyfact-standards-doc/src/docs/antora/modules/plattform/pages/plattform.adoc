...
Sie sieht eine hochverfügbare Produktionsumgebung, Testumgebungen für verschiedene Zwecke, sowie eine Entwicklungsumgebung vor.
...
NOTE: SAGA sind die „Standards und Architekturen für E-Government“ der deutschen Bundesverwaltung, siehe: https://www.cio.bund.de/Webs/CIO/DE/digitaler-wandel/Achitekturen_und_Standards/IT_Architektur_Bund/IT_Architektur_Bund-node.html[SAGA] - seit SAGA 5 wird bezüglich des Netzkonzeptes auf das BSI verwiesen.
