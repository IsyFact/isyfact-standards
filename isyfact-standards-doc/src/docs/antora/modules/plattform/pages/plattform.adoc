...
NOTE: SAGA sind die „Standards und Architekturen für E-Government“ der deutschen Bundesverwaltung, siehe: xref:literaturextern:inhalt.adoc#litextern-saga-5[SAGA] - seit SAGA 5 wird bzgl. des Netzkonzeptes auf das BSI verwiesen.
