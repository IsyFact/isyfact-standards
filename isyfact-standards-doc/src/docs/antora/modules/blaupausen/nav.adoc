...
* xref:vorgaben-architektur/master.adoc[Anwendungskern - Architektur - Vorgaben]
* xref:vorgaben-it-sicherheit/master.adoc[Anwendungskern -IT-Sicherheit - Vorgaben]
