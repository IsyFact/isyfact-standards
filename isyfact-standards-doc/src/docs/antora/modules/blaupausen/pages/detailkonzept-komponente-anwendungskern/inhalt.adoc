...
* Die Konfiguration des Loggings über Spring, beschrieben in den xref:isy-logging:nutzungsvorgaben/master.adoc#einleitung[Nutzungsvorgaben Logging].
* Die Bereitstellung von Metriken zur Überwachung, beschrieben im xref:isy-ueberwachung:konzept/master.adoc#einleitung[Konzept Überwachung].
* Die Verwendung der Schnittstellentechnologie HTTP Invoker, beschrieben im xref:isy-serviceapi-core:konzept/master.adoc#einleitung[Konzept HTTP-Invoker].
