...
:desc-table-anwcases: Anwendungsfallklassen
[id="table-anwcases",reftext="{table-caption} {counter:tables}"]
.{desc-table-anwcases}
[cols="1,4",options="header"]
|====
2+|{desc-table-anwcases}
...
* Die Konfiguration der Datenzugriffsschicht, beschrieben im <<DetailkonzeptKomponenteDatenzugriff>>.
...
* Die Verwendung der Schnittstellentechnologie HTTP Invoker, beschrieben im Konzept <<KonzeptHttpInvoker>>.
* Die Zugriffe auf ein LDAP erfolgen über Spring-LDAP, beschrieben im Konzept <<NutzungsvorgabenSpringLDAP>>.
* Die Implementierung von Dialogen und Masken erfolgt mit JSF und Spring-Webflow, beschrieben im Dokument <<DetailkonzeptKomponenteWebGUI>>.
...
:desc-listing-konfigurationsbean: Beispiel für Konfiguration des Anwendungskern mittels Konfigurations-Bean
...
* Bei HTTP Invoker Schnittstellen-Beans muss explizit eine Bean des eigentlichen Anwendungskontextes aufgerufen werden (siehe <<NutzungsvorgabenHttpInvoker>>).
...
Statt AOP ist das im <<DetailkonzeptKomponenteService>> beschriebene Konstrukt der Exception-Fassade zu verwenden.
...
:desc-image-dependeny-injection: Dependency Injection
[id="image-dependeny-injection",reftext="{figure-caption} {counter:figures}"]
.{desc-image-dependeny-injection}
...
:desc-table-dependeny-injection: Vergleich der Verfahren zur Dependency Injection
[id="table-dependeny-injection",reftext="{table-caption} {counter:tables}"]
.{desc-table-dependeny-injection}
|===
...
:desc-listing-constructor-injection: Verwendung von Constructor Injection
[id="listing-constructor-injection",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-constructor-injection}
[source,java]
----
@Component
