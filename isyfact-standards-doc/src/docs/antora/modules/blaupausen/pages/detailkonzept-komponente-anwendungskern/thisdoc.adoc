...
Gemäß den Vorgaben der xref:referenzarchitektur-it-system/master.adoc[Referenzarchitektur] basiert die Architektur eines IT-Systems auf der bekannten Drei-Schichten-Architektur.
