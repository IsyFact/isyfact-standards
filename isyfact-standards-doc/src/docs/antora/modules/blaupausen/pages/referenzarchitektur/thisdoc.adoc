...
*Querschnittssysteme* sind Anwendungssysteme, die xref:glossary:glossary:master.adoc#glossar-Basisdienst[Basisdienste] für mehrere Geschäftsanwendungen bereitstellen.
Diese Dienste sind oft technisch motiviert.

*Portal:* Das xref:glossary:glossary:master.adoc#glossar-Portal[Portal] stellt den Benutzern eine einheitliche Dialogoberfläche für den Zugriff auf die Dienste der Anwendungslandschaft zur Verfügung.
