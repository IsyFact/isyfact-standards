...
Die *IsyFact* ist eine freie allgemeine xref:glossary:glossary:master.adoc#glossar-Software-Factory[Software Factory (Glossar)] zum Bau von xref:glossary:glossary:master.adoc#glossar-IT-System>[IT-Systeme (Glossar)], die vom Bundesverwaltungsamt bereitgestellt wird.
Sie wurde entwickelt, um unterschiedliche xref:glossary:glossary:master.adoc#glossar-Geschaeftsanwendung[Geschäftsanwendungen (Glossar)] effizient entwerfen, realisieren und betreiben zu können.
Der Begriff Factory steht für die schnelle Erzeugung neuer xref:glossary:glossary:master.adoc#glossar-Anwendung[Anwendungen (Glossar)] durch Anpassung und Ausgestaltung vorgefertigter Elemente, die in eine standardisierte xref:glossary:glossary:master.adoc#glossar-Plattform>[Plattform (Glossar)] integriert werden können.
...
Die Referenzarchitektur unterscheidet zwischen den folgenden xref:glossary:glossary:master.adoc#glossar-Architektursicht[Architektursichten (Glossar)]:
...
*Software-Referenzarchitektur:* Dies ist eine software-technische Beschreibung der xref:glossary:glossary:master.adoc#glossar-Systemlandschaft[Systemlandschaft (Glossar)].
...
*Anwendungsdomänen:* Eine xref:glossary:glossary:master.adoc#glossar-Anwendungsdomaene[Anwendungsdomäne (Glossar)] gruppiert fachlich zusammengehörende Anwendungssysteme zur Unterstützung von Geschäftsprozessen, die als eine Einheit angesehen werden können.

*Anwendungssysteme:* Ein xref:glossary:glossary:master.adoc#glossar-Anwendungssystem[Anwendungssystem (Glossar)] ist eine zusammengehörende, logische Einheit aus Funktionen, Daten und Schnittstellen.
Es besteht aus Anwendungskomponenten und Querschnittskomponenten.
Anwendungssysteme unterstützen Geschäftsprozesse.
Stellt ein Anwendungssystem eine Fachlogik dar, so handelt es sich um eine xref:glossary:glossary:master.adoc#glossar-Geschaeftsanwendung[Geschäftsanwendung (Glossar)].
Ein Anwendungssystem ist Bestandteil der xref:glossary:glossary:master.adoc#glossar-A-Architektur[A-Architektur (Glossar)].
Aus Sicht der xref:glossary:glossary:master.adoc#glossar-T-Architektur[T-Architektur (Glossar)] bildet ein xref:glossary:glossary:master.adoc#glossar-IT-System>[IT-Systeme (Glossar)] die software-technische Umsetzung eines Anwendungssystems ab.
...
Im vorliegenden Dokument verwenden wir daher den neutralen Begriff *xref:glossary:glossary:master.adoc#glossar-Geschaeftsanwendung[Geschäftsanwendung (Glossar)]* für alle Arten von Anwendungssystemen, die eine bestimmte fachliche Funktionalität innerhalb einer Anwendungsdomäne realisieren.

*Querschnittssysteme* sind Anwendungssysteme, die xref:glossary:glossary:master.adoc#glossar-Basisdienst[Basisdienste (Glossar)] für mehrere Geschäftsanwendungen bereitstellen.
Diese Dienste sind oft technisch motiviert.

*Portal:* Das xref:glossary:glossary:master.adoc#glossar-Portal[Portal (Glossar)] stellt den Benutzern eine einheitliche Dialogoberfläche für den Zugriff auf die Dienste der Anwendungslandschaft zur Verfügung.
...
*Service-Gateway:* Im xref:glossary:glossary:master.adoc#glossar-Service-Gateway[Service Gateway (Glossar)] werden alle Services der Anwendungssysteme bereitgestellt, die externe Nutzer direkt nutzen dürfen.
...
Daher wird eine Referenzarchitektur aufgestellt, nach denen Anwendungssysteme (Geschäftsanwendungen und Querschnittssysteme) software-technisch in xref:glossary:glossary:master.adoc#glossar-IT-System>[IT-Systeme (Glossar)] umgesetzt werden.
...
Im Design des xref:glossary:glossary:master.adoc#glossar-Anwendungskern[Anwendungskerns (Glossar)] (siehe xref:detailkonzept-komponente-anwendungskern/master.adoc[Detailkonzept Komponente Anwendungskern] ) finden sich explizit Komponenten und Services.
...
Im Bereich der technischen Infrastruktur (xref:glossary:glossary:master.adoc#glossar-TI-Architektur>[IT-Architektur (Glossar)] <<>>) werden folgende Umgebungen beschrieben:
...
Die Aufteilung in Zonen leitet sich aus dem SAGA 4-Standard ab <<TODO anderes Dokument: AGA40>>.
