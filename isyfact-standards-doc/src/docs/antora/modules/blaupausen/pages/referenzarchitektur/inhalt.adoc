...
Hierzu gehören z.B. das Betriebssystem, Web-Server, Application-Server, Access-Manager, IAM und die Datenbank.
...
Neben den in der Datenbank gespeicherten Daten müssen auch andere Datenspeicher, wie z.B. die IAM-Daten oder Sourcen bei der Datensicherung berücksichtigt werden.
