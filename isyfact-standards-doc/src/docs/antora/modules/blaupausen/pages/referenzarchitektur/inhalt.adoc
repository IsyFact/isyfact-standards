...
* *xref:glossary:glossary:master.adoc#glossar-Querschnittssystem[Querschnittsanwendungen]* sind Anwendungssysteme, die Basisdienste für mehrere Geschäftsanwendungen bereitstellen, wie z. B. ein Behördenverzeichnis oder ein Outputmanagement.
...
*Das xref:glossary:glossary:master.adoc#glossar-Querschnittssystem[Querschnittsanwendungen]:* Eine Querschnittsanwendung bietet Geschäftsanwendungen querschnittlich genutzte Funktionalitäten an, etwa für die Bereitstellung von Schlüsseldaten.
