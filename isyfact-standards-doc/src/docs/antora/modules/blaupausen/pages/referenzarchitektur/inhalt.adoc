...
Folgende Prinzipien der Sicherheit liegen der Erstellung einer Systemlandschaft zu Grunde:
...
Folgende Abbildung zeigt die Umsetzung der Prinzipen in der Systemlandschaft:
