...
Diese kontextspezifischen Festlegungen werden in einem eigenen xref:methodik:tailoring/tailoring.adoc[_Tailoring_Dokument_] festgehalten, das beschreibt, wie die IsyFact im betreffenden Anwendungskontext einzusetzen ist.
