...
Zur Implementierung der Geschäftslogik kann die Geschäftsanwendung auch xref:glossary:glossary:master.adoc#glossar-ServiceFachlich[Services] anderer Geschäftsanwendung aufrufen.
