...
Dort erfolgt die Authentifizierung des Anwenders (schwarzer Schlüssel) mit Hilfe eines zentralen Querschnittservice je Anwendungslandschaft, dem IAM-Service.
