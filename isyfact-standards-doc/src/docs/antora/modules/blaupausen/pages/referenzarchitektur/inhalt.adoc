...
* *xref:glossary:glossary:master.adoc#glossar-Querschnittssystem[Querschnittssysteme]* sind Anwendungssysteme, die Basisservices für mehrere Geschäftsanwendungen bereitstellen, wie z. B. ein Behördenverzeichnis oder ein Outputmanagement.
...
Zur Implementierung der Geschäftslogik kann die Geschäftsanwendung auch xref:glossary:glossary:master.adoc#glossar-ServiceFunktional[Services] anderer Geschäftsanwendung aufrufen.
...
Durch die Aufteilung in Informations- & Servicezone, Logik- & Verarbeitungszone sowie Datenzone sind die Grundlagen geschaffen, um z.B. E-Government-Anwendungen sicher betreiben zu können.
