...
Beschäftigt man sich mit dem Entwurf und der Implementierung von Anwendungslandschaften, so stellt man fest, dass sich die einzelnen <<glossar-Geschaeftsanwendung,Geschäftsanwendungen>> im Allgemeinen sehr ähnlich sind.
...
image::../assets/images/IFBereiche.png[align="center",pdfwidth=45%,width=45%]
...
*Blaupausen:* <<glossar-Blaupause,Blaupausen>> beschreiben die vorgegebene Architektur und Konzepte einer Anwendungslandschaft für den Betrieb von Geschäftsanwendungen aus drei verschiedenen Sichten: der fachlichen Sicht, der Sicht der softwaretechnischen Umsetzung und der Sicht der technischen Infrastruktur.

*Bausteine:* <<glossar-Baustein,Bausteine>> sind konkrete, strukturierte Lösungen zur Umsetzung der in den Blaupausen beschriebenen Architektur und Konzepte.
...
*Methodik:* Im Rahmen einer Software-Factory bildet die <<glossar-Methodik>> die Grundlage für die Umsetzung von Geschäftsanwendungen.
...
Dazu bietet sie Konfigurationsanleitungen ausgewählter <<glossar-Werkzeug,Werkzeuge>>, z. B. für die Modellierung, die Programmierung, Tests oder die Fehlerverfolgung.
...
*Sicherheit:* Die Referenzarchitektur sieht bewährte Technologien und Produkte, eine Infrastruktur nach der Architekturrichtlinie für die IT des Bundes <<ArchitekturRichtlinieITBund>>, und nach klaren architektonischen Vorgaben erstellte Anwendungssysteme vor.
...
image::../assets/images/AnptRAafK.png[align="center"]
...
:desc-image-GA-AW2: Fachliche Architektur einer Anwendungslandschaft
...
*<<glossar-Anwendungsdomaene,Anwendungsdomaene>>:* Auf der obersten Hierarchieebene werden Anwendungsdomänen gebildet: Anwendungsdomänen sind fachlich eng zusammengehörige Mengen von Anwendungssystemen
...
*<<glossar-Anwendungssystem,Anwendungssysteme>>:* Ein Anwendungssystem ist eine zusammengehörende, logische Einheit aus Funktionen, Daten und Benutzungsschnittstellen.
...
* *<<glossar-Geschaeftsanwendung,Geschäftsanwendungen>>:* Eine Geschäftsanwendung implementiert für sich genommen oder im Zusammenspiel mit anderen Geschäftsanwendungen einen oder mehrere Geschäftsprozesse einer Anwendungsdomäne.
...
* *<<glossar-Querschnittssystem,Querschnittssysteme>>* sind Anwendungssysteme, die Basisdienste für mehrere Geschäftsanwendungen bereitstellen, wie z. B. ein Behördenverzeichnis oder ein Outputmanagement.

*<<glossar-Anwendungskomponente,Anwendungskomponenten>>:* Eine Anwendungskomponente beschreibt eine Menge funktional zusammenhängender Anwendungsfälle.
...
*Die <<glossar-Geschaeftsanwendung>>*: Eine Geschäftsanwendung implementiert allgemein die Geschäftsprozesse einer Domäne.
Geschäftsanwendungen können monolithisch strukturiert sein und alle Schichten der Software-Architektur umfassen, von der Benutzeroberfläche über Prozesse und <<glossar-Geschaeftslogik>> bis hin zur Datenspeicherung.
...
*Das <<glossar-Portal>>:* Die Referenzarchitektur sieht keinen Portal-Server im klassischen Sinne vor: Es gibt weder einen systemübergreifenden Rahmen noch eine systemübergreifende Navigation.
...
*Das <<glossar-Querschnittssystem>>:* Ein Querschnittssystem bietet Geschäftsanwendungen querschnittlich genutzte Funktionalitäten an, etwa für die Bereitstellung von Schlüsseldaten.
...
:desc-image-servicekommunikation: Interne und externe Servicekommunikation
[id="image-servicekommunikation",reftext="{figure-caption} {counter:figures}"]
.{desc-image-servicekommunikation}
image::../assets/images/servicekommunikation.dn.png[align="center"]
...
:desc-image-synchronous-call: Ablauf eines synchronen Service-Aufrufs
[id="image-synchronous-call",reftext="{figure-caption} {counter:figures}"]
.{desc-image-synchronous-call}
image::../assets/images/synchroner-service-aufruf.dn.png[align="center"]
...
:desc-image-http-messages: Aufbau von HTTP-Anfragen bzw. HTTP-Antworten
[id="image-http-messages",reftext="{figure-caption} {counter:figures}"]
.{desc-image-http-messages}
image::../assets/images/http-messages-aufbau.dn.png[align="center"]
...
:desc-image-asynchronous-call: Ablauf eines asynchronen Service-Aufrufs
[id="image-asynchronous-call",reftext="{figure-caption} {counter:figures}"]
.{desc-image-asynchronous-call}
image::../assets/images/asynchroner-service-aufruf.dn.png[align="center"]
...
:desc-image-queueing: Ablauf der Kommunikation beim Queueing
[id="image-queueing",reftext="{figure-caption} {counter:figures}"]
.{desc-image-queueing}
image::../assets/images/queueing.dn.png[align="center"]
...
:desc-image-jms-message: Aufbau einer JMS-Nachricht
[id="image-jms-message",reftext="{figure-caption} {counter:figures}"]
.{desc-image-jms-message}
image::../assets/images/jms-message-aufbau.dn.png[align="center"]
...
Die Gesamtheit aller Service-Provider und Service-Consumer eines internen IT-Systems wird als <<glossar-Service-Gateway>> bezeichnet.
...
image::../assets/images/extintServ.png[align="center"]
...
Zur Implementierung der Geschäftslogik kann die Geschäftsanwendung auch <<glossar-Service,Services>> anderer Geschäftsanwendung aufrufen.

*Das Portal:* Wie in Kapitel <<strukturierung-der-systemlandschaft>> beschrieben, nimmt das Portal die <<glossar-Anwender>>-Aufrufe entgegen und leitet sie an die Geschäftsanwendung weiter.
...
Die in dieser Abbildung angedeuteten Schichten eines IT-Systems (GUI, Batch, Service, Anwendungskern, Datenzugriff und Querschnitt) werden im Dokument <<IsyFactReferenzarchitekturITSystem>> erläutert.
...
:desc-image-CallFAmGuX: Aufrufbeziehungen für eine Geschäftsanwendung mit GUI und XML-Schnittstelle
[id="image-CallFAmGuX",reftext="{figure-caption} {counter:figures}"]
.{desc-image-CallFAmGuX}
image::../assets/images/CallFAmGuX.png[align="center"]
...
Eine detaillierte Liste der verbindlichen und empfohlenen Produkte sind im Dokument <<ProduktKatalog>> zu finden.
...
image::../assets/images/AlleSysUmgeb.png[align="center"]
...
image::../assets/images/TIArchPRU.png[align="center"]
...
image::../assets/images/TIArchSTU.png[align="center"]
...
image::../assets/images/TIArchETU.png[align="center"]
...
image::../assets/images/TIArchSWTU.png[align="center",pdfwidth=80%,width=80%]
...
image::../assets/images/verfuegbar.png[align="center"]
...
Auf die Überwachung der IT-Systeme wird im Dokument <<KonzeptUeberwachung>> im Detail eingegangen.
...
image::../assets/images/einfachsoArch.png[align="center"]
...
image::../assets/images/noCluster.png[align="center"]
