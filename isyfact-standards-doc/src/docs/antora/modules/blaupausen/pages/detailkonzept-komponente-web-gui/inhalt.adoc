...
<<image-RAGaAnw>> zeigt die Referenzarchitektur einer xref:glossary:glossary:master.adoc#glossar-Geschaeftsanwendung[Geschäftsanwendung (Glossar)].
...
Dialog-Komponenten verwenden grundsätzlich keine Klassen des xref:glossary:glossary:master.adoc#glossar-Anwendungskern[Anwendungskerns (Glossar)].
