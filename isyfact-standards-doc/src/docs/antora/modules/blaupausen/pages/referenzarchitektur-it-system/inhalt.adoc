...
Weitere und detaillierte Informationen sind in xref:glossary:literaturextern:inhalt.adoc#litextern-spring-cache-abstraction[Spring Cache Abstraction] einzusehen.
