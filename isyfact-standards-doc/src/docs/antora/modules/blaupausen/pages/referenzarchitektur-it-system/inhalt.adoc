...
Weitere und detaillierte Informationen sind in xref:literaturextern:inhalt.adoc#litextern-spring-cache-abstraction[der Spring Dokumentation] einzusehen.
...
Für weitere Informationen zu EHCache sind in der xref:literaturextern:inhalt.adoc#litextern-ehcache[EHCache Dokumentation] einzusehen.
