...
Der Anwendungskern stellt somit im wesentlichen allgemein nutzbare xref:glossary:glossary:master.adoc#glossar-service[Service] zur Verfügung.
...
Vorgaben zum Layout sind im xref:isyfact-style-doku:isy-style:styleguide.adoc[Styleguide] beschrieben.
