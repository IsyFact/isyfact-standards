...
Damit stellt der Anwendungskern innerhalb des Systems allgemein nutzbare Funktionalität zur Verfügung.
Weitere Details können auch dem xref:detailkonzept-komponente-anwendungskern/master.adoc[Detailkonzept Komponente Anwendungskern] entnommen werden.
...
Diese querschnittlichen Anwendungen sind in jeweils eigenen Dokumenten beschrieben.
