...
Damit stellt der Anwendungskern innerhalb des Systems allgemein nutzbare xref:glossary:glossary:master.adoc#glossar-ServiceFunktional[Services] zur Verfügung.
...
Vereinfachend können Anwendungskern-Komponenten persistente Daten an die xref:glossary:glossary:master.adoc#glossar-ServiceFunktional[Service]-Schicht (Kapitel <<servicezugriffe>>) weitergeben.
...
Dabei können alle Services des xref:glossary:glossary:master.adoc#glossar-Anwendungskern[Anwendungskerns] genutzt werden.
