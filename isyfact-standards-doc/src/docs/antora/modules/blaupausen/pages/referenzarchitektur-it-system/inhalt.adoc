...
Details zur Umsetzung von Berechtigungen sind in <<Berechtigungskonzept>> enthalten.
...
Weitere technische Details zur SPA-GUI sind im Dokument <<KonzeptAngular>> enthalten.
...
Weiterführende technische Details zu Services sind im Dokument <<DetailkonzeptKomponenteService>> enthalten.
