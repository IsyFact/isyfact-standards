...
Daher wird folgend die Referenzarchitektur definiert, nach der alle Anwendungssysteme der IsyFact software-technisch in IT-Systeme umgesetzt werden.
Die Referenzarchitektur basiert auf der bekannten Drei-Schichten-Architektur:
