...
wird über UC4 (siehe auch <<KonzeptKonfiguration>>) umgesetzt.
...
:desc-image-AnwLogBat: Die Anwendungslogik eines Batches (Zielarchitektur)
[id="image-AnwLogBat",reftext="{figure-caption} {counter:figures}"]
.{desc-image-AnwLogBat}
image::AnwLogBat.png[align="center"]
...
:desc-image-BatNetz: Ein Batch-Netz
[id="image-BatNetz",reftext="{figure-caption} {counter:figures}"]
.{desc-image-BatNetz}
image::BatNetz.png[align="center"]
...
:desc-image-GrobArchBatCanv: Grobe Architektur des Batchrahmens
[id="image-GrobArchBatCanv",reftext="{figure-caption} {counter:figures}"]
.{desc-image-GrobArchBatCanv}
image::GrobArchBatCanv.png[align="center",width=80%,pdfwidth=80%]
...
Dieser Kontext ist ein Kind-Kontext des eigentlichen <<glossar-Anwendungskontext,Anwendungskontextes>> und kann alle Beans des Anwendungskontextes verwenden.
...
Die Einbindung weiterer Datenbanken ist in <<DetailkonzeptKomponenteDatenzugriff>> beschrieben.
...
Für die Vorlage-Anwendung <<Vorlageanwendung>> zeigt <<image-BeanGriffBat>> eine Auswahl der vorhandenen Beans.
...
:desc-image-BeanGriffBat: Bean-Zugriffe des Batchrahmens
[id="image-BeanGriffBat",reftext="{figure-caption} {counter:figures}"]
.{desc-image-BeanGriffBat}
image::BeanGriffBat.png[align="center"]
...
===== Namenskonvention
//tag::namenskonvention[]
:desc-table-batckonfig-konfigurationsparameter-kommandozeile: Batches: Konfigurationsparameter Kommandozeile
[id="table-batckonfig-konfigurationsparameter-kommandozeile",reftext="{table-caption} {counter:tables}"]
.{desc-table-batckonfig-konfigurationsparameter-kommandozeile}
[cols="1,4",options="header"]
|====
2+|{desc-table-batckonfig-konfigurationsparameter-kommandozeile}
...
:desc-table-CLIBATCanv: Kommandozeilen-Parameter des Batchrahmens
[id="table-CLIBATCanv",reftext="{table-caption} {counter:tables}"]
.{desc-table-CLIBATCanv}
...
:desc-table-batch-property-files: Batches: Benennung Konfigurationsdateien
[id="table-batch-property-files",reftext="{table-caption} {counter:tables}"]
.{desc-table-batch-property-files}
[cols="1,4",options="header"]
|====
2+|{desc-table-batch-property-files} (unter resources/resources/batch)
...
//tag::namenskonvention[]
:desc-table-batckonfig-konfigurationsparameter-konfigurationsdatei: Batches: Konfigurationsparameter Konfigurationsdatei
[id="table-batckonfig-konfigurationsparameter-konfigurationsdatei",reftext="{table-caption} {counter:tables}"]
.{desc-table-batckonfig-konfigurationsparameter-konfigurationsdatei}
[cols="1,4",options="header"]
|====
2+|{desc-table-batckonfig-konfigurationsparameter-konfigurationsdatei}
|*Schema* m|<Parametername>=<Parameterwert> +
...
:desc-table-PropBATCanv: Die Properties des Batchrahmens
[id="table-PropBATCanv",reftext="{table-caption} {counter:tables}"]
.{desc-table-PropBATCanv}
...
:desc-listing-excludefrombatchcontext: Verwendung der Annotation @ExcludeFromBatchContext
[id="listing-excludefrombatchcontext",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-excludefrombatchcontext}
[source,java]
----
@Component
...
:desc-image-SchemTabBatStat: Tabellen-Schema für die Batchrahmen-Tabelle
[id="image-SchemTabBatStat",reftext="{figure-caption} {counter:figures}"]
.{desc-image-SchemTabBatStat}
image::SchemTabBatStat.png[align="center"]
...
:desc-table-SchemTabBatStat2: Das Schema der Tabelle BatchStatus
[id="table-SchemTabBatStat2",reftext="{table-caption} {counter:tables}"]
.{desc-table-SchemTabBatStat2}
[cols="3,7",options="header"]
|====
|Spalte |Beschreibung
...
:desc-image-JMXOverBat: Die JMX Überwachung eines Batches
[id="image-JMXOverBat",reftext="{figure-caption} {counter:figures}"]
.{desc-image-JMXOverBat}
image::JMXOverBat.png[align="center"]

Bereitgestellt werden folgende Informationen:

:desc-table-JMXAttr: JMX-Attribute
...
Der Batchrahmen nutzt die T-Komponente Sicherheit (siehe <<NutzungsvorgabenSicherheit>>), um den anfragenden Benutzer über den Access-Manager der Plattform zu authentifizieren.
...
:desc-table-CharBatUse: Die Eigenschaften des Batchbenutzers
[id="table-CharBatUse",reftext="{table-caption} {counter:tables}"]
.{desc-table-CharBatUse}
...
:desc-listing-BSPStartBAT: Beispielhaftes Startskript für einen Batch
[id="listing-BSPStartBAT",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-BSPStartBAT}
[source,bash]
----
#!/bin/bash
#
...
:desc-table-FormAusDat: Format der Ergebnisdatei
[id="table-FormAusDat",reftext="{table-caption} {counter:tables}"]
.{desc-table-FormAusDat}
...
:desc-table-GenRetCodeBatCanv: Allgemeine Return-Codes des Batchrahmens
[id="table-GenRetCodeBatCanv",reftext="{table-caption} {counter:tables}"]
.{desc-table-GenRetCodeBatCanv}
...
:desc-table-shellskript: Batches: Shellskript
[id="table-shellskript",reftext="{table-caption} {counter:tables}"]
.{desc-table-shellskript}
[cols="1,4",options="header"]
|====
2+|{desc-table-shellskript}
...
In solchen Fällen muss dann eine Sonderlösung, wie z. B. ein SQL-Skript, gefunden werden.
