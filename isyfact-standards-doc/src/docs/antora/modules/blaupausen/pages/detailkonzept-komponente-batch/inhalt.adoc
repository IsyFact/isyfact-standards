...
|`Batchrahmen.MaxWiederholungen` |Maximale Anzahl automatischer Neustarts für einen fehlerhaft abgebrochenen Batch.
|====
...
Ist `Batchrahmen.MaxWiederholungen` nicht konfiguriert oder auf den Wert `-1` gesetzt, gibt es keine Begrenzung der Neustarts.
