...
Details zu dem Datenzugriff, welcher in diesem Beispiel aufgeführt ist, oder alternative Datenzugriffe, befinden sich in dem Dokument xref:blaupausen:detailkonzept-komponente-datenzugriff/inhalt.adoc[Detailkonzept Datenzugriff].
