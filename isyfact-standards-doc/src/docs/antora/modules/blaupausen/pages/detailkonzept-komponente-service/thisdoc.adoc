...
Entsprechend der xref:referenzarchitektur:software-technisch/backend.adoc[] stellen IT-Systeme Services über die technische Komponente „Service“ zur Verfügung.
