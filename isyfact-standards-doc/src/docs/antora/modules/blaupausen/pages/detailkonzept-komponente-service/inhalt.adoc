...
|===
|Metadatum|Benennung|Herleitung
...
Dieses Thema wird im entsprechenden Nutzungskonzept xref:detailkonzept-komponente-datenzugriff/master.adoc[Detailkonzept Komponente Datenzugriff] behandelt.
