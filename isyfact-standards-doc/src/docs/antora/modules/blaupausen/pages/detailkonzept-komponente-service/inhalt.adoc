...
NOTE: Für die Versionierung von Schnittstellen gelten gesonderte Vorgaben, die in  xref:werkzeuge:versionskontrolle/master.adoc#einleitung[IsyFact Versionierung] definiert sind.
