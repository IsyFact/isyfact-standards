...
Unter *Historisierung* (auch xref:literaturextern:inhalt.adoc#litextern-temporale-datenhaltung[temporale Datenhaltung] genannt) versteht man das Festhalten der zeitlichen Entwicklung von Daten durch Speichern in einer Datenbank.
...
Bei der Archivierung sind dementsprechend Randbedingungen wie Integrität, Unveränderlichkeit und Vertraulichkeit einzuhalten (s. xref:literaturextern:inhalt.adoc#litextern-it-grundschutz-bsi[IT-Grundschutz BSI]).
