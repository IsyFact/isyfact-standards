...
NOTE: Der xref:glossary:literaturextern:inhalt.adoc#litextern-it-grundschutz-m471[IT-Grundschutz (M 4.71)] sieht die Verwendung von _Database Links_, die für eine Datenbank-übergreifende Versionierung genutzt werden können, nur unter strengen Auflagen zulässig, die eine Verwendung erheblich erschweren.
