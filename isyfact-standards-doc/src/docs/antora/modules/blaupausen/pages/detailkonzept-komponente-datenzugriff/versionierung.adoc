...
****
Nur eine Lösung, _Oracle Database Links_, bietet im Zusammenspiel mit Oracle-Datenbanken eine generische, transaktionssichere Lösung für dieses Problem an.
Allerdings sind Oracle Database Links laut Maßnahme M 4.71 des IT-Grundschutzes (xref:glossary:literaturextern:inhalt.adoc#litextern-it-grundschutz-m471[IT-Grundschutz M 4.71]) nur unter strengen Auflagen zulässig, die eine Verwendung erheblich erschweren.
