...
Allerdings sind Oracle Database Links laut Maßnahme M 4.71 des IT-Grundschutzes (xref:literaturextern:inhalt.adoc#litextern-it-grundschutz-m471[IT-Grundschutz M 4.71]) nur unter strengen Auflagen zulässig, die eine Verwendung erheblich erschweren.
