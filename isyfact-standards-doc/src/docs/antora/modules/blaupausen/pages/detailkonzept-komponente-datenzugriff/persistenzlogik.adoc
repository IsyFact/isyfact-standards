...
Sie werden im Baustein xref:isy-persistence:konzept/vorgaben-konventionen.adoc#vererbungshierarchien[JPA/Hibernate] beschrieben zusammen mit Regeln für ihre Verwendung.
