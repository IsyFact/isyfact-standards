...
Die Jakarta Persistence API Specification beschreibt deshalb mehrere Strategien des O/R-Mappings von Vererbungshierarchien.
Sie werden im Baustein xref:isy-persistence:konzept/vorgaben-konventionen.adoc#vererbungshierarchien-regeln[JPA/Hibernate] beschrieben zusammen mit Regeln für ihre Verwendung.
...
****
Vererbungshierarchien zur Abbildung in relationalen Datenbanken sollten nur eine Oberklasse mit einigen Subklassen umfassen, höchstens jedoch zwei Vererbungslevel haben.
****
