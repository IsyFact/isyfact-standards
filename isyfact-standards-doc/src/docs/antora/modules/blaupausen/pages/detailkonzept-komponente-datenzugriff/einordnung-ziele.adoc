...
* xref:referenzarchitektur:software-technisch/backend/anwendungskern.adoc#transaktionssteuerung[Detailkonzept Komponente Anwendungskern],
* xref:detailkonzept-komponente-batch/master.adoc#die-transaktionssteuerung[Detailkonzept Komponente Batch],
* xref:referenzarchitektur:software-technisch/backend/serviceschicht.adoc#transaktionssteuerung[Detailkonzept Komponente Service].
