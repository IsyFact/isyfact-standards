...
Gemäß den Vorgaben der xref:referenzarchitektur-it-system/master.adoc#die-referenzarchitektur-eines-it-systems[Referenzarchitektur IT-System] basiert die Architektur eines IT-Systems auf der bekannten Drei-Schichten-Architektur.
...
image::blaupausen:detailkonzept-datenzugriff/IFRefArcITSsysPers.png[]
