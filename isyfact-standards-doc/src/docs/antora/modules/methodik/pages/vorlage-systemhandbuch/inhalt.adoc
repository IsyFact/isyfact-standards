...
NOTE: Weitere fachliche Details können in der xref:vorlage-systemhandbuch/inhalt.adoc#systemspezifikation[Systemspezifikation] nachgelesen werden.
...
NOTE: Weitere technische Details können im xref:vorlage-systemhandbuch/inhalt.adoc#systementwurf[Systementwurf] nachgelesen werden.
...
Das Datenbankschema ist vollständig im xref:vorlage-systementwurf/inhalt.adoc[Systementwurf] dokumentiert.
