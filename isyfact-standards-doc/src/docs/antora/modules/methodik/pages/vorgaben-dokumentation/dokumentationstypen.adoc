...
|Inhalt
a|
* Bricht die Referenzarchitektur auf Aspekte der xref:glossary:glossary:master.adoc#glossar-t-architektur[software-technischen Architektur] wie zum Beispiel Batches, Persistenz oder Services, herunter.
...
|Vorlage / Beispiel
a|
xref:blaupausen:detailkonzept-komponente-batch/master.adoc[]
|===
