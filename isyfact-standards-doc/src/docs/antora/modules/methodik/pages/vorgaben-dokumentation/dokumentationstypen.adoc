...
|Ziel
|Vorgaben zur Umsetzung bezogen auf die Referenzarchitektur, sofern sie eine technische Ausrichtung haben.

|Inhalt
a|
* Bricht die Referenzarchitektur auf Aspekte der xref:glossary:glossary:master.adoc#glossar-t-architektur[software-technischen Architektur] wie z.B. Batches, Datenzugriff oder Services, herunter.
* Enthält Architekturvorgaben und Architekturentscheidungen.
