...
|Vorlage / Beispiel
a|
xref:blaupausen:referenzarchitektur/master.adoc[]
|===
...
|Inhalt
a|
* Beschreibt Blaupausen für xref:glossary:glossary:master.adoc#glossar-t-architektur[software-technische Architektur] wie z.B. Batches, Datenzugriffe oder Services.
* Enthält Architekturvorgaben und Architekturentscheidungen.
...
|Vorlage / Beispiel
a|
xref:blaupausen:detailkonzept-komponente-datenzugriff/einordnung-ziele.adoc[]
|===
...
|Vorlage / Beispiel
a|
xref:isy-persistence:konzept.adoc[]
|===
...
|Vorlage / Beispiel
a|
xref:isy-persistence:nutzungsvorgaben/umsetzung-datenzugriff.adoc[Nutzungsvorgaben JPA/Hibernate]
|===
...
|Vorlage / Beispiel
a|* xref:werkzeuge:dokumentation/changelog/changelog-doku.adoc[Vorgaben zu Changelogs] +
* xref:changelog:changelog.adoc[Changelog der IsyFact]
|===
...
|Inhalt
a|* Beschreibung des Themas (s. xref:werkzeuge:seitenvorlage.adoc[])
...
|Inhalt
a|* Beschreibung des Werkzeugs (s. xref:werkzeuge:seitenvorlage.adoc[])
...
|Vorlage / Beispiel
a|* xref:werkzeuge:seitenvorlage.adoc[]
