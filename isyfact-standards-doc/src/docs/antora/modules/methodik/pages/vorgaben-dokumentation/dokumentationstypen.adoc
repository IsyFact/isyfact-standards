...
|Inhalt
a|
* Bricht die Referenzarchitektur auf Aspekte der xref:glossary:glossary:master.adoc#glossar-t-architektur[software-technischen Architektur] wie z.B. Batches, Persistenz oder Services, herunter.
