...
komponente>. ...
  <domäne>
	= (Name gemäß fachlicher Architektur, zb. "meinedomaene")
  <anwendungssystem>
	= (Name gemäß fachlicher Architektur)
  <layer>
...
[green]#Richtig#::
		`de.bund.bva.meinedomäne.meineanwendung.service.admin` +
		`de.bund.bva.isyfact.meineanwendung.persistence` +
		`de.bund.bva.isyfact.logging.common.layout`

[red]#Falsch#::
		`de.bund.bva.isyfact.MeineAnwendung.persistence` +
		`de.bund.bva.isyfact.meineanwendung.persistence.meineanwendung` +
		`de.bund.bva.meinedomäne.meineanwendung.service.adminmeineanwendung`
...
.icon:shield[] Erzeugung von Zufallszahlen unter Linux
****
