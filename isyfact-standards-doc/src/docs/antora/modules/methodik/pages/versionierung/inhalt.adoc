...
Vorveröffentlichungsbezeichner, dessen Elemente durch Punkte voneinander getrennt werden, an die Patch Version angehängt wird.
...
Zusätzlich zur Version der Anwendung muss der Container oder die Installationsdatei mit Build-Metadaten versehen werden, um
