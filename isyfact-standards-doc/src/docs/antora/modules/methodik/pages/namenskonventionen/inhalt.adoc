...
.Konfigurationsparameter
[id="table-konfiguration-parameter",reftext="{table-caption} {counter:tables}"]
[cols="1,4",options="header"]
|====
2+|Konfigurationsparameter – IT-System
|*Schema* m|<präfix>.<system>.(<fachkomponente>.)<parameter>
|*Beispiele* m|awl.bsp-backend.auskunft.ergebnisse.anzahl

awl.bsp-backend.caching

2+h|Konfigurationsparameter – IsyFact-Bibliothek
|*Schema* m|<präfix>.<bibliothek>.<parameter>
|*Beispiele* m|isy.security.oauth2.client.default-certificate-ou
