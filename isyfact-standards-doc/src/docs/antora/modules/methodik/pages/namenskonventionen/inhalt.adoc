...
include::isy-persistence:page$nutzungsvorgaben/umsetzung-datenzugriff.adoc[tag=namenskonvention]

===== Historisierung

include::isy-persistence:page$nutzungsvorgaben/historisierung.adoc[tag=namenskonvention]

===== Versionierung

include::isy-persistence:page$nutzungsvorgaben/versionierung.adoc[tag=namenskonvention]
