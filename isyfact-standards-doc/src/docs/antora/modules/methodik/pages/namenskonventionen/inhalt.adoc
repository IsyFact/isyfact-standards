...
NOTE: Siehe xref:literaturextern:inhalt.adoc#litextern-rpm-packaging-guide[RPM Packaging Guide]
...
include::werkzeuge:dokumentation/bearbeitung-antora.adoc[tag=namenskonvention]
