...
TODO
include::../../40_Methodik/Java-Programmierkonventionen/inhalt.adoc[tag=namenskonvention]
...
Sie werden unter anderem für Projektnamen in Eclipse, Dokument Basis / Context Root bei Schnittstellen-URLs und als Namen von Deployment-Einheiten (vgl. Kapitel <<TODOrpm-pakete>>) verwendet.
...
TODO
include::../../20_Bausteine/Konzept_Servicegateway/inhalt.adoc[tag=namenskonvention]
...
.Name einer ausgelagerten technsichen Geschäftskomponente
...
==== Persistenz
TODO
include::../../10_Blaupausen/Detailkonzept_Komponente_Datenzugriff/inhalt.adoc[tag=namenskonvention]

===  Anwendungskern
TODO
include::../../10_Blaupausen/Detailkonzept_Komponente_Anwendungskern/inhalt.adoc[tag=namenskonvention]

[[batches]]
=== Batchbereich
TODO
include::../../10_Blaupausen/Detailkonzept_Komponente_Batch/inhalt.adoc[tag=namenskonvention]


[[schnittstellen]]
=== Externe Schnittstellen aus Sicht der Anwendung
TODO
include::../../10_Blaupausen/Detailkonzept_Komponente_Service/inhalt.adoc[tag=namenskonvention]
include::../../20_Bausteine/Konzept_HttpInvoker/inhalt.adoc[tag=namenskonvention]

[[web-gui]]
==== Web-GUI
TODO
include::../../10_Blaupausen/Detailkonzept_Komponente_Web_GUI/inhalt.adoc[tag=namenskonvention]


[[deploymentbetrieb-von-anwendungen]]
=== Deployment/Betrieb von Anwendungen
TODO
include::../../20_Bausteine/Konzept_Deployment/inhalt.adoc[tag=namenskonvention]
