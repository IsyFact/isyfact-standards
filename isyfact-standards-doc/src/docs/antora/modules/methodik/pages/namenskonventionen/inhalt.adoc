...
[[rest-schnittstellen]]
==== REST-Schnittstellen
include::referenzarchitektur:software-technisch/backend/service/rest.adoc[tag=namenskonvention]
include::referenzarchitektur:software-technisch/backend/service/rest-vorgaben-konventionen.adoc[tag=namenskonvention]
