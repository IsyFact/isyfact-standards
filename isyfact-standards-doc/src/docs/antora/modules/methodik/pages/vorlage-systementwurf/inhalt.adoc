...
Details zur Implementierung und Dateninhalten der Schnittstellen finden sich in der Konstruktion der jeweiligen Services unter <<service,Architektur des Teilsystems A/Service>>.
+
...
Folgende Stereotypen für Verbinder werden empfohlen:_
...
Da die Druckstücke durch das Output Management erstellt werden, reduziert sich dies auf:_
...
* _Es werden alle Attribute dargestellt. Besondere technische Attribute für Primärschlüssel und optimistisches Locking werden über die Stereotypes „Id“ und „Version“ gekennzeichnet._
