...
* _Zunächst wird gezeigt, wie sich das neue System in die gesamte technische Anwendungslandschaft einfügt._
siehe Kapitel: <<einbettung-in-anwendungslandschaft, Systemüberblick/Einbettung in die Anwendungslandschaft>>
* _Danach wird das System detailliert, indem gezeigt wird, wie die Teilsysteme des neuen Systems zusammen arbeiten.
siehe Kapitel: <<gesamtsystem-systemueberblick, Systemarchitektur des Gesamtsystems/Systemüberblick>>_
...
Die folgende Abbildung zeigt beispielhaft das EA-Modell für die Vorlage-Anwendung CD-Register._

====

.Paketstruktur des Enterprise Architect Modells
[id="image-packetstruktur-enterprise-architect-modells", reftext = "{figure-caption} {counter:figures}"]
image::methodik:vorlage-systementwurf/packetstruktur-enterprise-architect-modells.png[align="center", title-align=center]
...
+
** Die Schnittstellenübersicht des Systems erfolgt der Übersichtlichkeit halber auf zwei Abstraktionsebenen: Auf Ebene der Gesamtanwendungslandschaft erfolgt dies im Kapitel <<einbettung-in-anwendungslandschaft,Systemüberblick/Einbettung in die Anwendungslandschaft>> beschrieben.
...
+
** Die zu spezifizierenden Systemelemente sind der Gegenstand von Kapitel <<systemarchitektur-gesamtsystems>>, insbesondere in den Kapiteln <<architektur-teilsystems-a, Architektur des Teilsystems A (ff)>>.
...
.Einbettung von <Anwendungssystem (roten Rahmen platzieren)> in die Systemlandschaft.
[id="image-einbettung-anwendungssystem", reftext = "{figure-caption} {counter:figures}"]
image::methodik:vorlage-systementwurf/einbettung-anwendungssystem.png[align = center, title-align=center]
...
Das IT-System <System> wird konform zur Referenzarchitektur der IsyFact Version 1.0 umgesetzt.
Die folgende Tabelle führt die vom IT-System verwendeten Elemente der IsyFact auf.


.Verwendete Elemente der IsyFact (Standards und Erweiterungen)
...
| {set:cellbgcolor} IsyFact-Referenzarchitektur |berücksichtigt |1.0 |xref:blaupausen:referenzarchitektur/master.adoc[IsyFact Referenzarchitektur]
4+|*Blaupausen* {set:cellbgcolor:#D9D9D9}
|Anwendungskern {set:cellbgcolor}|berücksichtigt |_Standard_ |
|Batch |berücksichtigt |_Standard_ |
|Datenzugriff |berücksichtigt |_Standard_ |
|Web GUI |berücksichtigt |_Standard_ |
...
|LDAP-Zugriffe |berücksichtigt |_Standard_ |
|Logging |berücksichtigt |_Standard_ |
|Sicherheitskomponente |Abweichungen |_Standard_ |xref:isy-logging:konzept/master.adoc[Konzept Logging] xref:isy-logging:nutzungsvorgaben/master.adoc[Nutzungsvorgaben Logging]
...
|Styleguide |berücksichtigt |_Standard_ |
...
image::methodik:vorlage-systementwurf/teilsysteme.png[align = center, title-align=center]
...
* _Gelb für Querschnittssysteme (R/G/B: 255 / 255 / 153)_
* _Violett für das Service-Gateway (R/G/B: 255 / 153 / 204)_
* _Hellgrün für Portal-Systeme (R/G/B: 204 / 255 / 204)_
* _Weiß für externe Systeme oder Produkte (LDAP, Datenbank etc.) (R/G/B: 255 / 255 / 255)_
====
...
spezifische Festlegung für Registeranwendungen. Siehe Dokument xref:einstieg:einstieg/master.adoc[IsyFact Einstieg>]
====
...
====
_Zunächst erst mal ein Überblick: Kurze Beschreibung der wichtigsten Eckpunkte der TI-Architektur._
...
image::methodik:vorlage-systementwurf/deployment-diagramm.png[align = center, title-align=center]

====
_Wichtige Inhalte:_

* _Zuordnung der Server bzw. Laufzeitumgebungen zu den Saga-Zonen_
* _Zuordnung der Deployment-Einheiten auf die Server/Laufzeitumgebungen_
* _Kommunikationsbeziehungen werden zu den Loadbalancern bzw. Firewalls dargestellt.
Es soll klarwerden über welche Zonengrenzen hinweg mit welchen Protokollen kommuniziert wird._
...
* _Keine konkreten Adressen, Portnummern, Dimensionierungen, sondern eine logische Sicht_
====
...
Diese Umgebung ist für Anwendungen nach Referenzarchitektur vorgegeben, deshalb kann der Abschnitt unten in der Regel übernommen werden.
Die Versionen sind nach dem Produktkatalog zu überprüfen und mit dem Gesamtprojekt abzustimmen.
...
|Betriebssystem |SUSE Linux Enterprise Server |[yellow]#10 SP1# |64Bit Version
|Java-Laufzeitumgebung |Sun JDK |[yellow]#11.5.0# |64Bit Version
...
In der <<table-mengengeruest-datenbank>> ist eine Abschätzung für die Datenbankgröße enthalten.
...
.Mengengerüst für die Dateien auf dem lokalen Laufwerk
...
.Benötigte Bibliotheken und Drittsoftware
...
Diese werden jetzt in eigenen Unterkapiteln der Reihe nach beschrieben. Ggf. kann es sinnvoll sein, ein Kapitel voran zu stellen, das Gemeinsamkeiten aller Teilsysteme erklärt._
...
_Die Teilsysteme haben (soweit es sich um Geschäftsanwendungen handelt) folgende, fest vorgegebene T-Architektur:_
====

.Darstellung der Teilsysteme
[id="image-darstellung-teilsysteme", reftext = "{figure-caption} {counter:figures}"]
image::methodik:vorlage-systementwurf/darstellung-teilsysteme.png[align = center, title-align=center, width=75%]
...
_Falls es sich bei dem Teilsystem z. B. um ein Sevicegateway oder einen Querschnittlichen Service handelt, muss die Gliederung im Sinne des oben gesagten. angepasst werden._
====
...
* _Externe Systeme und Produkte als Component-Elemente_
...
.Überblick über die Teilsysteme
[id="image-ueberblick-teilsysteme", reftext = "{figure-caption} {counter:figures}"]
image::methodik:vorlage-systementwurf/ueberblick-teilsysteme.png[align = center, title-align=center]

====
_Die Komponentenstruktur des Anwendungskerns findet sich in der GUI, Batch, Service und Persistenz wieder.
...
image::methodik:vorlage-systementwurf/uml-komponentendiagramm.png[align = center, title-align=center]
...
image::methodik:vorlage-systementwurf/komponenten-zusammenhaenge.png[align = center, title-align=center]
...
====
_Die allgemeinen Vorgaben zur GUI sind in einem eigenen Konzept der IsyFact beschrieben und werden hier nicht wiederholt.
Ggf. werden hier Spezialisierungen und zusätzliche Festlegungen zur GUI beschrieben._

_In diesem Abschnitt wird in angemessener Tiefe die konkrete Konstruktion der GUI beschrieben, in der Regel die Konstruktion der einzelnen Masken und Abläufe._

_Hier wird der Rückbezug zur Systemspezifikation gezogen, indem folgende Inhalte zugeordnet werden:_

* _Die Dialoge (DIA) der Spezifikation den WebFlow-Konfigurationen_
* _Die Masken (MAS) der Spezifikation den einzelnen Seiten_
* _Die Maskenelemente (MEL) den einzelnen JSF GUI-Komponenten_
====
...
Dies sind Services, die per httpInvoker bereitgestellt werden.
...
_Die Entitäten des Datenmodells sollen den Komponenten des Anwendungskerns zugeordnet werden, z. B. zu „Meldung“ oder „Auskunft“.
Für die Komponenten, die nicht einer dieser Komponenten zugeordnet werden können, dient die Komponente „Basisdaten“.
...
image::methodik:vorlage-systementwurf/logisches-datenmodell.png[align = center, title-align=center]
...
====
_Analog zu oben, für jedes Teilsystem entsteht ein eigenes Unterkapitel 3.x_
====
...
Download xref:methodik:attachment$vorlage-generated/Vorlage-Systementwurf.zip[Systementwurf]
// end::inhalt[]
