...
** Die zu spezifizierenden Systemelemente sind der Gegenstand der <<systemarchitektur-gesamtsystems>>, insbesondere der <<BSP-1u2-GK,Systemarchitektur der Teilsysteme (ff.)>>.
...
Die Instanziierung dieser Architektur befindet sich in der Beschreibung der <<systemarchitektur-gesamtsystems>>.
...
Dieses Kapitel ist die nächste Stufe der Konkretisierung nach der Einordnung in die Anwendungslandschaft aus Kapitel <<einbettung-in-anwendungslandschaft,Systemüberblick/Einbettung in die Anwendungslandschaft>>_
...
_Kann tabellarisch dargestellt werden._
====
