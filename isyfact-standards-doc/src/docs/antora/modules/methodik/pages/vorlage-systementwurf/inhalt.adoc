...
:desc-image-packetstruktur-enterprise-architect-modells: Paketstruktur des Enterprise Architect Modells
[id="image-packetstruktur-enterprise-architect-modells", reftext = "{figure-caption} {counter:figures}"]
.{desc-image-packetstruktur-enterprise-architect-modells}
image::vorlage-systementwurf/packetstruktur-enterprise-architect-modells.png[align = center, title-align=center]
...
:desc-image-einbettung-anwendungssystem: Einbettung von <Anwendungssystem (roten Rahmen platzieren)> in die Systemlandschaft.

[id="image-einbettung-anwendungssystem", reftext = "{figure-caption} {counter:figures}"]
.{desc-image-einbettung-anwendungssystem}
image::vorlage-systementwurf/einbettung-anwendungssystem.png[align = center, title-align=center]
...
| {set:cellbgcolor} IsyFact-Referenzarchitektur |berücksichtigt |1.0 |<<IsyFactReferenzarchitektur>>
...
|Sicherheitskomponente |Abweichungen |_Standard_ |<<KonzeptLogging>> <<NutzungsvorgabenLogging>>
...
spezifische Festlegung für Registeranwendungen. Siehe Dokument <<IsyFactEinstieg>>
====
...
:desc-image-darstellung-teilsysteme: Darstellung der Teilsysteme
[id="image-darstellung-teilsysteme", reftext = "{figure-caption} {counter:figures}"]
.{desc-image-darstellung-teilsysteme}
image::vorlage-systementwurf/darstellung-teilsysteme.png[align = center, title-align=center, width=75%]
