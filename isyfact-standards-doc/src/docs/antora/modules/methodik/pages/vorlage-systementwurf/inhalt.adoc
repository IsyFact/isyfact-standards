...
* *Mensch-Maschine-Schnittstelle (Bedienkonzept):* Ein Bedienkonzept ist durch die IsyFact nicht vorgegeben.
Es wird jedoch vorausgesetzt, dass ein solches Bedienkonzept für die Organisation, die die IsyFact einsetzt, bereits vorhanden ist und verwendet werden kann.
