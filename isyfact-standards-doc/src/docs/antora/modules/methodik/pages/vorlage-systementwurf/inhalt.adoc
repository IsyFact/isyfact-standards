...
* _Weiß für externe Systeme oder Produkte (Datenbank etc.) (R/G/B: 255 / 255 / 255)_
====
...
|Java-Laufzeitumgebung | xref:einstieg:produktkatalog/produktvorgabenAllgemein.adoc[siehe Produkt-Katalog] |  xref:einstieg:produktkatalog/produktvorgabenAllgemein.adoc[siehe Produkt-Katalog] | xref:einstieg:produktkatalog/produktvorgabenAllgemein.adoc[siehe Produkt-Katalog]
