...
.Packetstruktur des Enterprise Architect Modells
[id="image-packetstruktur-enterprise-architect-modells", reftext = "{figure-caption} {counter:figures}"]
image::methodik:vorlage-systementwurf/packetstruktur-enterprise-architect-modells.pngresbrowser.png[align="center", title-align=center]
