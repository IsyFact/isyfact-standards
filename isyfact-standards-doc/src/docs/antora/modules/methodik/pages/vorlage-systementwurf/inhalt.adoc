...
Das folgende Listing zeigt beispielhaft das EA-Modell._
====
...
📂 Geschäftsanwendung XYZ
  📂 Systementwurf
    📂 1 Systemarchitektur des Gesamtsystems
      📂 Querschnittkonzepte
      📂 Systemüberblick
      📂 TI-Architektur
    📂 <<IT-System>> 2 Geschäftskomponente XYZ
      📂 Anwendungskern
    ...
    📂 <<IT-System>> 3 Service-Gateway
    📂 4 Rückbezug Systemspezifikation
      📂 Anwendungsfälle
