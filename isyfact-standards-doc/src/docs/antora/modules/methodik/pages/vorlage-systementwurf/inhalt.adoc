...
| {set:cellbgcolor} IsyFact-Referenzarchitektur |berücksichtigt |5.0 |
...
|Sicherheitskomponente |Abweichungen |_Standard_ | <<adr-gesamtsystem-1>>
...
[NOTE]
====
Im Kapitel <<systemueberblick>> wurde die in der Systemspezifikation beschriebene Anwendung in IT-Systeme zerlegt.
...
Ein Diagramm, das den technischen Kontext des Gesamtsystems zeigt, befindet sich im <<systemueberblick>>.
