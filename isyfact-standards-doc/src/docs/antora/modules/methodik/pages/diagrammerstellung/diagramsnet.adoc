...
TIP: In der Web-Version wird die Bibliothek am besten über ihre xref:attachment$IsyFact.drawiolib.xml[URL] eingebunden.
...
Diese muss manuell in die Konfiguration von Visual Studio Code integriert werden.
