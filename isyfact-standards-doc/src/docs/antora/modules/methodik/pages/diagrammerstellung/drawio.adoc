...
NOTE: In *neueren Versionen* von draw.io befindet sich die Option btn:[Adaptive Farben] unter dem Menüpunkt *Datei > Seite einrichten...* (siehe https://www.drawio.com/docs/manual/editor/appearance/adaptive-colours/#adaptive-colour-settings[Adaptive colour settings icon:external-link-square[], window=_blank]).
