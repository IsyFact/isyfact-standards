...
Die IsyFact empfiehlt die Verwendung von *draw.io* und *Enterprise Architect*.

[[table-anforderungen]]
.Entscheidungshilfe zur Auswahl eines Werkzeugs zur Diagrammerstellung
[cols="5,1,1",options="header"]
|===
|Anforderung an die Diagrammerstellung|Enterprise Architect|draw.io
...
== Einsatzszenarien draw.io

https://www.drawio.com/[_draw.io_] eignet sich insbesondere für:
...
NOTE: Für das Wiki-System _Confluence_ sowie das Ticket-System _Jira_ der Firma _Atlassian_ gibt es das Add-on _draw.io_.
Die Bearbeitung von Diagrammen im Kontext Wiki-getriebener Dokumentation erfolgt somit voll integriert.

Die IsyFact bietet xref:diagrammerstellung/drawio.adoc[eine Konfiguration sowie vorgefertigte Elemente] für die Erstellung von Diagrammen mit draw.io.
