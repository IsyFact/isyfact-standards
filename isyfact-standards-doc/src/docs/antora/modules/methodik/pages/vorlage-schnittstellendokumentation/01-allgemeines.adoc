...
_Zu jeder Schnittstelle werden die link:../vorlage-schnittstellendokumenation/03-nachbarsystemschnittstellen.adoc#eingabeparameter[Eingabeparameter] links und die link:03-nachbarsystemschnittstellen.adoc#ausgabeparameter[Ausgabeparameter] rechts neben dem Schnittstellensymbol aufgeführt._
