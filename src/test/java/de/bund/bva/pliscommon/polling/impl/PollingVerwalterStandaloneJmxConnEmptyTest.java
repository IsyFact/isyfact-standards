...
@ContextConfiguration(inheritLocations = true, locations = { 
    "classpath:resources/spring/konfiguration-standalone-jmxconnempty.xml"})
public class PollingVerwalterStandaloneJmxConnEmptyTest extends AbstractPollingStandaloneTest {
