...
/**
 * Dies ist das Entität fuer einen Batch-Aufruf. Sie enthaelt die Kontext- Informationen ueber den Aufruf
 * sowie Informationen ueber den aktuellen Status des Batches.
 */
@Entity
public class BatchStatus {
    ...
    /**
     * Der Datenbank-Schluessel (bei DB-Queries), bei dem der letzte Commit durchgefuehrt wurde. Hierbei ist
     * es notwendig, dass in der Query ueber den Schluessel sortiert wurde.
     */
    ...
    /**
     * @param satzNummerLetztesCommit
     *            the satzNummerLetztesCommit to set
     */
    ...
    /**
     * @param schluesselLetztesCommit
     *            the schluesselLetztesCommit to set
     */
    ...
    /**
     * @param datumLetzterStart
     *            the datumLetzterStart to set
     */
    ...
    /**
     * @param datumLetzterAbbruch
     *            the datumLetzterAbbruch to set
     */
