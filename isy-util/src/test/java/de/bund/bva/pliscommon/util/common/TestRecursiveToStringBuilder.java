...
public class TestRecursiveToStringBuilder {
	...
	public void testNonPrimitiveArray() throws InvalidNameException {
		Object [] arr = new Object[]{new Integer(1), new String("20"), new String[]{"foo", "bar"}, new CompositeName()};
	...
	public void testIterable(){		
		...
		Iterable<Integer> it = (Iterable<Integer>) list;
		String result = RecursiveToStringBuilder.recursiveToString(it);
	...
	public void testGenericObject(){
		...
		assertTrue(result.startsWith("de.bund.bva.pliscommon.util.exception.MessageSourceFehlertextProvider"));
	}
	...
	public void testSelfcontainingObject(){
		...
		assertTrue(result.startsWith("de.bund.bva.pliscommon.util.common.test.MyNode"));
	}
