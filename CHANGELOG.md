# 5.0.0
## FEATURES
- `IFS-1798`: [isyfact-standards-doc] Formulierung von Empfehlungen für den Einsatz von 2nd Level Caches in der Persistenz von Backends
- `IFS-4737`: [isyfact-standards-doc] Auszeichnung der Bausteine in Bezug auf IsyFact-Standards und IsyFact-Erweiterungen
