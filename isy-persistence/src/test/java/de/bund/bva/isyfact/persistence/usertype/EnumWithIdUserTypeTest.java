...
public class EnumWithIdUserTypeTest {
    ...
    public void testAbstractImmutableUserType() {
        ...
        assertEquals(Vermerkstyp.NACHRICHT_EMPFANGEN.hashCode(),
            userType.hashCode(Vermerkstyp.NACHRICHT_EMPFANGEN));
        ...
        assertEquals((Serializable) Vermerkstyp.NACHRICHT_EMPFANGEN,
            userType.disassemble(Vermerkstyp.NACHRICHT_EMPFANGEN));
        assertEquals((Object) Vermerkstyp.NACHRICHT_EMPFANGEN,
            userType.assemble(Vermerkstyp.NACHRICHT_EMPFANGEN, null));
        assertEquals((Object) Vermerkstyp.NACHRICHT_EMPFANGEN,
            userType.replace(Vermerkstyp.NACHRICHT_EMPFANGEN, null, null));
    }
}
