...
Zusätzlich zu den Anforderungen an die Inhalte einer Log-Nachricht (<<KonzeptLoggging>> Kapitel 4.1.1), sollen folgende Informationen als Marker in der Log-Nachricht enthalten sein:

:desc-table-logging-data: Standard für zu erfassende Logging-Informationen
[id="table-logging-fields",reftext = "{table-caption} {counter:tables}"]
