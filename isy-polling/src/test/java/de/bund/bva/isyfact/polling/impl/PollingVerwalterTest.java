...
@SpringBootTest(classes = {
    TestConfig.class, PollingVerwalterTest.TestConfig.class },
...
public class PollingVerwalterTest extends AbstractPollingTest {
    ...
    public void startePollingTest() throws Exception {
        ...
        // Für Cluster 3 ist keine MBean definiert und ein nicht existenter Port. Daher kann die MBean nicht
        // erreicht werden
    ...
    public void annotationTest() {
        ...
        Assert.assertTrue("Ausführungszeitpunkt wurde nicht geändert.",
            ausfuehrungszeitpunkt1 != ausfuehrungszeitpunkt2);
    }
