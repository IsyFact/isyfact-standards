...
/**
 * Interface der Komponente Polling Verwalter. Der Polling-Verwalter verwaltet mehrere Polling-Cluster und
 * unterstützt die Synchronisierung von Polling-Aktivitäten innerhalb eines Polling-Clusters. <br>
 * Ein Polling-Cluster besteht aus Menge von Servern, die jeweils die gleiche Nachrichtenquelle abfragen und
 * wird durch eine innerhalb der Anwendung eindeutige Id identifiziert.
 * 
 */
public interface PollingVerwalter {
     ...
     * @return true, falls diese Instanz der Anwendung das Polling starten kann, false sonst.
     */
