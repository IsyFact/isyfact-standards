...
** `oracle.datasource.database-url`
** `oracle.datasource.database-username`
** `oracle.datasource.database-password`
** `oracle.datasource.database-schema-default`
** `oracle.datasource.pool-name`
** `oracle.datasource.pool-min-active`
** `oracle.datasource.pool-max-active`
** `oracle.datasource.pool-validate-on-borrow`
** `oracle.datasource.pool-wait-timeout`
** `oracle.datasource.pool-inactive-timeout`
** `oracle.datasource.pool-time-to-live-timeout`
** `oracle.datasource.pool-abandoned-timeout`
** `oracle.datasource.pool-max-reuse-time`
** `oracle.datasource.pool-max-reuse-count`
** `oracle.datasource.pool-statement-cache`
** `oracle.datasource.jdbc-timeout-connect`
** `oracle.datasource.jdbc-timeout-read`
** `oracle.datasource.jdbc-disable-oob`
...
// TODO: Beschreibung für Annotationen NichtInBatchKonfig/AnwendungsKonfig
