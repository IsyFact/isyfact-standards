...
public class LegacyTransformatorTest {
    ...
    public void checkLegacyTransformationDinNorm() {
        ...
        Assert.assertEquals("a(TM)permilRCCàDJeoe \t'\"", legacyTransformator.transformiereOhneTrim(STRING_DIN_NORM));
        Assert.assertEquals("a(TM)permilRCCàDJeoe \t'\"", legacyTransformator.transformiere(STRING_DIN_NORM));
    }
