...
@ContextConfiguration(locations = { "/aufrufKontextInterceptorTest.xml" })
public class AufrufKontextInterceptorAnnotationTest {

    /**
     * Zugriff auf den AufrufKontextVerwalter, um zu überprüfen, ob der AufrufKontext korrekt gesetzt / nicht gesetzt
     * wurde.
     */
    @Autowired
