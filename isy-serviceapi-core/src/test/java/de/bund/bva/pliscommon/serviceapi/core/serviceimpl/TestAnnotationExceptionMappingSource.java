...
public class TestAnnotationExceptionMappingSource {
    ...
    @Test
    public void testGetToExceptionClass() throws SecurityException {
    ...
    @Test
    public void testGetToExceptionClassExceptionNotInMapping() throws SecurityException {
        // Braucht man, damit der ClassLoader das entsprechende Package und Implementierungsklasse lädt.
        Class<?> implClass = RemoteBeanImpl.class;
    ...
    @Test
    public void testGetGenericTechnicalToException() throws SecurityException {
        // Braucht man, damit der ClassLoader das entsprechende Package und Implementierungsklasse lädt.
        Class<?> implClass = RemoteBeanImpl.class;
