...
/**
 * Tested, ob der {@link StelltLoggingKontextBereitInterceptor} auch für Klassen ohne Annotations eine KorrelationsID
 * (AufrufKontextTO) zurückgibt.
 */
public class StelltLoggingKontextBereitAspectTest {
    ...
    public void setUp() {
        ...
        Logger logger = (Logger) LoggerFactory.getLogger("de.bund.bva.pliscommon.serviceapi.core.aop.StelltLoggingKontextBereitInterceptor");
