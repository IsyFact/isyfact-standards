...
/**
 * Die Testklasse TestLoggingKontextAspect kann gelöscht werden, wenn die
 * Klasse LoggingKontextAspect.java, welche als @Deprecated annotiert ist, gelöscht wurde.
 * (Anmerk. die Funktionalität der Klasse LoggingKontextAspect wird von der Klasse
 * StelltLoggingKontextBereit.java übernommen).
 *
 * Die in dieser Klasse vorhandenen Testmethoden sind in die neu erstellte Testdatei
 * StelltLoggingKontextBereitAspectTest "gewandert", so dass durch Löschung
 * von TestLoggingKontextAspect.java keine QM-Einbuße entsteht.
 */
@Deprecated
