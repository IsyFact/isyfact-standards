package de.bund.bva.pliscommon.serviceapi.autoconfigure;

import de.bund.bva.pliscommon.aufrufkontext.AufrufKontextFactory;
import de.bund.bva.pliscommon.aufrufkontext.AufrufKontextVerwalter;
import de.bund.bva.pliscommon.serviceapi.core.aop.StelltLoggingKontextBereitInterceptor;
import de.bund.bva.pliscommon.serviceapi.core.aufrufkontext.StelltAufrufKontextBereitInterceptor;
...
public class IsyServiceApiCoreAutoConfiguration {
    ...
    public Advisor stelltLoggingKontextBereitAdvisor(StelltLoggingKontextBereitInterceptor interceptor) {
        ...
        pointcut.setExpression("@annotation(de.bund.bva.pliscommon.serviceapi.core.aop.StelltLoggingKontextBereit) || @within(de.bund.bva.pliscommon.serviceapi.core.aop.StelltLoggingKontextBereit)");
    ...
    public Advisor stelltAufrufKontextBereitAdvisor(StelltAufrufKontextBereitInterceptor interceptor) {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut();
        pointcut.setExpression("@annotation(de.bund.bva.pliscommon.serviceapi.core.aufrufkontext.StelltAufrufKontextBereit) || @within(de.bund.bva.pliscommon.serviceapi.core.aufrufkontext.StelltAufrufKontextBereit)");
        return new DefaultPointcutAdvisor(pointcut, interceptor);
    }
}
